...
class MaintenanceJobVExamFormInspectComponent extends Model
{
    use HasFactory;

    protected $table = 'maintenance.form_inspect_component';
    ...
    public function hasManyComponent(){
        return $this->hasMany(MaintenanceJobVExamFormInspectComponentSub::class, 'ins_comp_id');
    }
}
