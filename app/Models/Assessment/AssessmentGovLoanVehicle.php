...
class AssessmentGovLoanVehicle extends Model
{
    use HasFactory;

    protected $table = 'assessment.assessment_gov_loan_vehicle';

    protected $fillable = [
        'assessment_gov_loan_id',
        'category_id',
        'sub_category_id',
    ...
    public function hasAssessmentDetail(){
        return $this->belongsTo(AssessmentGovLoan::class, 'assessment_gov_loan_id');
    }
