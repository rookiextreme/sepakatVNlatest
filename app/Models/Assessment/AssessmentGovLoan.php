...
class AssessmentGovLoan extends Model
{
    use HasFactory;
    // public $applicant_name;
    protected $table = 'assessment.assessment_gov_loan';
    ...
    public function hasVehicle(){
        return $this->hasOne(AssessmentGovLoanVehicle::class, 'assessment_gov_loan_id');
    }

    public function hasVehicleMany(){
        return $this->hasMany(AssessmentGovLoanVehicle::class, 'assessment_gov_loan_id')->whereHas('hasAssessmentVehicleStatus', function($q){
            $q->whereNotIn('code', ['00']);
        });
    }

    public function hasManyVehicleModelWithTotal(){
        return $this->hasMany(AssessmentGovLoanVehicle::class, 'assessment_gov_loan_id')
