...
class AssessmentDisposal extends Model
{
    use HasFactory;

    protected $table = 'assessment.assessment_disposal';
    ...
    public function hasVehicle(){
        return $this->hasOne(AssessmentDisposalVehicle::class, 'assessment_disposal_id');
    }

    public function hasVehicleMany(){
        return $this->hasMany(AssessmentDisposalVehicle::class, 'assessment_disposal_id')->whereHas('hasAssessmentVehicleStatus', function($q){
