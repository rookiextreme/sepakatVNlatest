  		...
  		<script>
	  		...
	  		// for current year
	  			$('.jqyc-header').click(function(e){
					...
					location.href = "{{ route('maintenance.calendarmonth')}}?selectedMonth="+selectedMonth+"&selectedYear="+selectedYear;
	  			});
	  			...
	  			$('#calendaryear').on('jqyc.changeYear', function (event) {
                    ...
                    @php
                        foreach ($listAppointments as $appointment){
                                ...
                                $theyear = date('Y', strtotime($appointment->appointmentdate));
                                $themonth = date('n', strtotime($appointment->appointmentdate));
                                $theday = date('d', strtotime($appointment->appointmentdate));
