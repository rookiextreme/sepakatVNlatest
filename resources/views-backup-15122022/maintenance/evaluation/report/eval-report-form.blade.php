...
<body class="content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                    href="javascript:parent.openPgInFrame('{{ route('maintenance.evaluation.register', ['id' => $detail->hasMaintenanceDetail->id, 'tab' => 2 ]) }}')">Kenderaan Di Selenggara</a></li>
                <li class="breadcrumb-item active" aria-current="page"> {{$detail && $detail->where('id',$vehicle_id)->first() ? $detail->where('id',$vehicle_id)->first()->plate_no : ''}}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="main-content" style="padding-right:0px">
        ...
        <div class="row mt-2 no-printme">
            <div class="col-md-12">
                <div class="btn-group float-start">
                    <span class="btn cux-btn" onclick="window.print()">Cetak</span>
                </div>
            </div>
        </div>
            {{-- @php
            ...
            <div class="col-md-12">
                ...
                <section id="detail" class="tab-content">
                    @include('maintenance.evaluation.report.tab.eval-report-detail')
                </section>
            </div>
    ...
    <script>
        ...
        function searching(value){
            ...
            if(value == 'click'){
                value = $('#searching').val();
                if(value){
                    window.location.href = "{{route('maintenance.evaluation.vehicle.report')}}?search="+value;
                }
