    ...
    <table class="table table-borderless" id="letter{{$template_type_code}}" style="width: 100%">
        ...
        <tr>
            <td colspan="3" class="" style="line-height: 21px">
                ...
                dan mengesahkan tiada kerosakan pada enjin.
            </td>
        </tr>

        <tr>
            <td colspan="3" class="" style="line-height: 21px">
                3.  Sehubungan dengan itu, kerja pembaikan yang dicadangkan adalah seperti berikut :
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3">
                4.	Sekiranya terdapat pertambahan kerja-kerja pembaikan, pihak tuan boleh merujuk semula kepada pihak kami untuk tujuan pengesahan semula.
            </td>
        </tr>
