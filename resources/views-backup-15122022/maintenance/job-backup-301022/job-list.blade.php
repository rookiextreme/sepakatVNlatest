                ...
                <tbody id="sortable">
                        ...
                        @if (count($maintenance_job_list) > 0)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('maintenance.job.register', [ 'id' =>  $maintenance->id, 'tab' => $tab ])}}">{{$maintenance->hasVehicle() && $maintenance->hasVehicle()->first() ? $maintenance->hasVehicle()->first()->plate_no : ''}}</a></td>
