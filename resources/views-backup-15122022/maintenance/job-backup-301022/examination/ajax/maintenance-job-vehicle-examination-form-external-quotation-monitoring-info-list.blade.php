...
<div class="table-responsive">
    <table class="table table-bordered">
        ...
        <tbody>
            @if($monitoringInfoList && $monitoringInfoList->count() == 0)
            <tr class="no-record">
                ...
                <tr data-ref-info-code="{{$monitorInfo->hasRefInfo && $monitorInfo->hasRefInfo->code ? $monitorInfo->hasRefInfo->code : ''}}">
                    ...
                    <td class="align-top">
                        <div data-monitorInfo="{{$monitorInfo}}" class="btn-group">
                            <span onclick="editExternalQuotationMonitorInfo(this)" class="btn cux-btn small"> <i class="fal fa-pen-nib"></i></span>
                            <span onclick="delExternalQuotationMonitorInfo({{$monitorInfo->id}})" class="btn cux-btn small"> <i class="fal fa-trash-alt"></i></span>
                        </div>
                    </td>
