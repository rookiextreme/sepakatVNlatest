                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if($vehicle->hasMaintenanceVehicleStatus->code == '04')
                            ...
                            href="{{route('jasperReport', ['format' => 'pdf', 'title' => 'Sijil Kenderaan', 'report_name' => 'maintenance_vehicle_certificate', 'table_name' => 'maintenance_job', 'vehicle_id' => $vehicle->id])}}"
                            >
                            Lihat Sijil
                            </a>
                        @endif
...
{{$vehicleList->links('pagination.ajax-default', [
    'targetDivList' =>  '#maintenance_job_vehicle_certificate',
    'params' => $params
])}}
