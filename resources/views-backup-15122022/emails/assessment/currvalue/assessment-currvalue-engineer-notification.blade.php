@php
    ...
    $AssessmentCurrvalueVehicle = AssessmentCurrvalueVehicle::where('assessment_currvalue_id',$details['assessment_id'])->get();
@endphp
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div style="max-width:500px;font-size:12px;font-family:Arial, Helvetica, sans-serif">
        ...
        <br><br>
        Proses pemeriksaan bagi permohonan No. Rujukan <b>{{$details['no_rujukan']}}</b> telah disemak oleh Penolong Jurutera.
        Bagi pemohon bernama, {{$details['applicant_name']}}.
        Diminta Tuan/Puan untuk mengesahkan permohonan ini.</div>
    <br/><br/>
