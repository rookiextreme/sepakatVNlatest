...
<form class="row" id="frm_cerificate" enctype="multipart/form-data">
    ...
    <div class="col-md-12" id="assessment_gov_loan_vehicle_certificate">
...
<script type="text/javascript">
    ...
    loadAssessmentGovLoanVehicleCertificate = function() {
        $.get("{{ route('assessment.gov_loan.vehicle-certificate.list') }}", function(result){
            $('#assessment_gov_loan_vehicle_certificate').html(result);
        });
    }
    ...
    editCertificate = function(vehicle_id, assessment_id){
        ...
        $.ajax({
        url: '{{Route("assessment.gov_loan.vehicle.getCertificateDetails")}}',
        type: 'get',
        data: {
    ...
    submitEditCertificate = function(data) {
        ...
        $.ajax({
            url: "{{ route('assessment.gov_loan.vehicle.editCertificate.save') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                loadAssessmentGovLoanVehicleCertificate();
            },
