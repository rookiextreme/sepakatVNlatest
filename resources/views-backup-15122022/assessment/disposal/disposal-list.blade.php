                    ...
                    @endphp
                     <tr>
                        ...
                        <td class="col-edit">
                            ...
                            <br>
                            <div class="btn-group">
                                    <button class='btn cux-btn' onclick="parent.openPgInFrame('{{route('assessment.disposal.register', [ 'id' =>  $disposal->id, 'tab' => $tab ])}}')"><i class="fa fa-pencil-alt"></i></button>
                        ...
                        <td><a href="{{route('assessment.disposal.register', [ 'id' =>  $disposal->id, 'tab' => $tab ])}}">{{$disposal->ref_number}}</a></td>
                        <td><a href="{{route('assessment.disposal.register', [ 'id' =>  $disposal->id, 'tab' => $tab ])}}">{{$disposal->applicant_name}}</a></td>
