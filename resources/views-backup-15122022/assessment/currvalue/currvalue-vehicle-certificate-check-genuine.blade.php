...
<body class="content">
    <div class="mytitle">Penilaian Pinjaman Kerajaan</div>
            ...
            <div class="row">
                @if($detail)
                    <div class="form-group">
                        <label for="" class="form-label">Sijil Ini Adalah Diperakui Sah. No Pendaftaran: {{$detail->plate_no}}</label>
                    </div>
                @else
                    <div class="form-group">
                        <label for="" class="form-label">Sijil Ini Tidak Diperakui Sah. No Pendaftaran: {{$detail->plate_no}}</label>
                        {{-- <div class="text-dark">{{$detail->plate_no}}</div> --}}
                    </div>
                @endif
            </div>
        </div>
