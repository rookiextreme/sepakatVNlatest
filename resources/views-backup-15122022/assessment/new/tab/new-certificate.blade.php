...
<form class="row" id="frm_cerificate" enctype="multipart/form-data">
    ...
    <div class="col-md-12" id="assessment_new_vehicle_certificate">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="small-title">Maklumat Sijil
                    <div>Kenderaan Baharu yang telah dinilai</div>
                </div>
                <span>
...
<script type="text/javascript">
    ...
    loadAssessmentNewVehicleCertificate = function() {
        $.get("{{ route('assessment.new.vehicle-certificate.list') }}", function(result){
            $('#assessment_new_vehicle_certificate').html(result);
        });
    }
    ...
    editCertificate = function(vehicle_id, assessment_id){
        ...
        $.ajax({
        url: '{{Route("assessment.new.vehicle.getCertificateDetails")}}',
        type: 'get',
        data: {
    ...
    submitEditCertificate = function(data) {
        ...
        $.ajax({
            url: "{{ route('assessment.new.vehicle.editCertificate.save') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                loadAssessmentNewVehicleCertificate();
            },
