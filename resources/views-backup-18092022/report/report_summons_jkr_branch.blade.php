...
<body class="content">
<div class="mytitle printme">Rekod Saman JKR Cawangan (Belum Selesai)</div>
<div class="sect-top no-printme">
    <div class="mytitle">Saman Kenderaan Milik JKR Persekutuan Mengikut Cawangan Sehingga {{\Carbon\Carbon::now()->format('d F Y')}}</div>
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Rekod Saman JKR Cawangan Ibu Pejabat (Belum Selesai)</li>
        </ol>
    </nav>
</div>
<div class="sect-top-dummy no-printme"></div>
<div class="btn-group float-end mt-2">
    <button class="btn cux-btn bigger no-printme" type="button" onClick="window.print();"><i class="fal fa-print text-success"></i>&nbsp;Cetak</button>
    <a class="btn cux-btn bigger" href="{{route('report.report.summon.export.excel', ['view' => 'report_summons_jkr_branch'])}}"> <i class="fa fa-file-export"></i> Excel</a>
</div>
<div class="main-content" style='margin-top:50px;'>
    <div class="detailing table-responsive">
        <table style='width:100%'>
            <thead>
                <tr>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2" colspan="2">Pemilik / Cawangan </td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Negeri Penempatan </td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' colspan="3" >Pengeluar Saman</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Jumlah</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">No Pendaftaran</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">No Notis Saman</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Tarikh Kesalahan</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Tarikh Terima Surat Saman (CDPK)</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Tarikh Notis Saman</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Jenis Saman</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Status</td>
                </tr>
                <tr>

                    <td class="col-mth header-depreciation"  style='color:black !important; font-family:mark-bold;' >PDRM</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' >JPJ</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' >PBT</td>
