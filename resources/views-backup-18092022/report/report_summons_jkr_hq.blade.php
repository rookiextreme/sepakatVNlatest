...
<body class="content">
<div class="mytitle printme">Rekod Saman JKR Cawangan Ibu Pejabat (Belum Selesai)</div>
<div class="sect-top no-printme">
    <div class="mytitle">Rekod Saman JKR Cawangan Ibu Pejabat (Belum Selesai)</div>
...
<div class="dropdown inline float-end">
    <span class="btn cux-btn bigger no-printme" onClick="window.print()"><i class="fal fa-print text-success"></i>&nbsp;Cetak</span>
</div>
<div class="main-content" style='margin-top:50px;'>
    <div class="detailing">
        <table style='width:100%'>
            <thead>
                <tr>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2" colspan="2">JKR Cawangan Ibu Pejabat </td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2" colspan="2">Negeri Penempatan </td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' colspan="3" >Jenis Saman</td>
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">No Plate</td>
                    ...
                    <td class="col-mth header-depreciation" style='color:black !important; font-family:mark-bold;' rowspan="2">Tarikh Terima Surat</td>
            ...
            @foreach ($samanList as $index => $saman)
                ...
                <tr>
                    ...
                    <td class="col-mth header-depreciation" >{{$saman->placement}}</td>
                    <td class="col-mth header-depreciation" colspan="2" >{{$saman->state_desc}}</td>
