        ...
        <div class="btn-group">
            ...
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item yearly" xvalue = '2021' {{ $year == 2021 ? 'style=background-color:lightgrey': ''}}> 2021</a></li>
                    <li><a class="dropdown-item yearly" xvalue = '2020' {{ $year == 2020 ? 'style=background-color:lightgrey': ''}}> 2020</a></li>
                    <li><a class="dropdown-item yearly" xvalue = '2019' {{ $year == 2019 ? 'style=background-color:lightgrey': ''}}> 2019</a></li>
                </ul>
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-focus thin-underline">{{($data_unpaid[$loop->index]->total)/($item->total == 0 ? "1" : $item->total)*100}}</td>
                        <td class="end thin-underline"></td>
                    </tr>
