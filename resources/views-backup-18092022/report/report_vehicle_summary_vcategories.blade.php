...
<div class="sect-top no-printme">
    ...
    <div class="dropdown btn-group inline float-end no-printme">
        ...
        <a class="btn cux-btn bigger" href="{{route('report.report.disaster_ready.export.excel', ['view' => 'report_vehicle_summary_vcategories'])}}"> <i class="fa fa-file-export"></i> Excel</a>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $( "#sortable_summary_report_vehicle_summary_vcategories" ).sortable({
            cursor: "move",
            ...
            stop: function (evt) {
  				...
  				for(var i = 0; i<$("#sortable_summary_report_vehicle_summary_vcategories tr.ui-state-default").length; i++){
  				var data = $("#sortable_summary_report_vehicle_summary_vcategories tr.ui-state-default")[i];
