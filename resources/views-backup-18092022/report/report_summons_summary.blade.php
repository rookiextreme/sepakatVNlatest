...
<div class="main-content" style='margin-top:50px;'>
    <div class="detailing">
       <table>
            <thead>
                <tr>
                    <td class="col-mth header-depreciation" rowspan="2">JKR Cawangan Ibu Pejabat / Negeri</td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-mth header-depreciation" >Jumlah Saman JKR Ibu Pejabat</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_pdrm}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_jpj}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_pbt}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_paid}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_paid_pctg}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_unpaid}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_hq_unpaid_pctg}}</td>

                </tr>

                <tr>

                    <td class="col-mth header-depreciation" >Jumlah Saman JKR Negeri</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_pdrm}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_jpj}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_pbt}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_paid}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_paid_pctg}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_unpaid}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon_negeri_unpaid_pctg}}</td>

                </tr>

                <tr>

                    <td class="col-mth header-depreciation" >Jumlah Saman Keseluruhan</td>
                    <td class="col-mth header-depreciation" >{{$total_pdrm_summon}}</td>
                    <td class="col-mth header-depreciation" >{{$total_jpj_summon}}</td>
                    <td class="col-mth header-depreciation" >{{$total_pbt_summon}}</td>
                    <td class="col-mth header-depreciation" >{{$total_summon}}</td>
                    <td class="col-mth header-depreciation" >{{$total_paid_summon}}</td>
                    <td class="col-mth header-depreciation" >{{$total_paid_summon_pctg}}</td>
                    <td class="col-mth header-depreciation" >{{$total_unpaid_summon}}</td>
                    <td class="col-mth header-depreciation" >{{$total_unpaid_summon_pctg}}</td>
