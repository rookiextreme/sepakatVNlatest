...
@php
    ...
    $lblRequestFU = $ApplicationDAO->lblRequestFU;
    $lblRequestFUMsg = $ApplicationDAO->lblRequestFUMsg;
...
@endphp
    <div>
        <div class="login-box">
            <div class="top-title pb-2">{{$lblRequestFU}}</div>

                <div class="row">
                    <div class="col-md-12">

                            <div class="form-group">
                                <label for="ttl_196">{{$lblRequestFUMsg}} [{{$email}}]</label>
                            </div>
