        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="btn-group">
                        <a class="btn cux-btn bigger" href="{{route('report.report.assessment.export.excel', ['view' => 'report_assessment_branch_month', 'is_report' => true, 'year' => $year_selected])}}"> <i class="fa fa-file-export"></i> Excel</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-custom no-footer" style="width: 100%;">
            <thead>
                ...
                <tr>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd; border-left-width: 1px;">Jan</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Feb</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Mac</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Apr</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Mei</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Jun</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Julai</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Ogos</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Sept</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Okt</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd;">Nov</th>
                    <th style="text-align:center; vertical-align: middle; border-radius: 0px;border-bottom-color: #d7d7dd; border-right-width: 1px;">Dec</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($list as $index => $branch)
                    <tr>
                        ...
                        @endphp
                            <td style="background-color: #d7d7dd; text-align: center;">{{$branch['by_month'][$index2]}}</td>
                        @endforeach
                        @php
                    ...
                    @foreach ($branch['by_assessment'] as $index2 => $assessment)
                        <tr>
                            ...
                            @endif
                            <td style="text-align: left !important; padding-left: 15px !important; border-left-style: none !important; text-align: center;">{{$assessment['name']}}</td>
                            @foreach ($assessment['by_month'] as $index3 => $a_month)
                            @php
                                $total_by_assessment += $a_month;
                            @endphp
                                <td style="text-align: center;">{{$a_month}}</td>
                            @endforeach
...
<script type="text/javascript">
    $(document).ready(function() {
        initTab();
        let url = "{{route('assessment.report.branch.month')}}";
