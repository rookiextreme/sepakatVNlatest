                ...
                <tbody id="sortable">
                    ...
                    @endphp
                     <tr>
                        ...
                        <td><a href="{{route('assessment.safety.register', [ 'id' =>  $safety->id, 'tab' => $tab ])}}">{{$safety->ref_number}}</a></td>
                        <td><a href="{{route('assessment.safety.register', [ 'id' =>  $safety->id, 'tab' => $tab ])}}">{{$safety->applicant_name}}</a></td>
