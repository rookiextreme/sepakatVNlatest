...
<form class="row" id="frm_vehicle_assessment" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-12" id="assessment_safety_vehicle_assessment">
...
<div class="modal fade" id="assessmentSafetyVehicleVerificationModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="assessmentSafetyVehicleVerificationModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    promptSubmitForVerificationModal = function(){
        $('#assessmentSafetyVehicleVerificationModal').modal('show');
    }

    submitForVerification = function(){
        $.post("{{ route('assessment.safety.verification') }}", {
            '_token': '{{ csrf_token() }}'
        }, function(result){
    ...
    loadAssessmentSafetyVehicleAssessment = function() {
        $.get("{{ route('assessment.safety.vehicle-assessment.list') }}", function(result){
            $('#assessment_safety_vehicle_assessment').html(result);
        });
    }
    ...
    $(document).ready(function(){
        ...
        @if($detail)
        loadAssessmentSafetyVehicleAssessment();
        @endif
