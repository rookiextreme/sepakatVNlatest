        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <p>
                        <i class="fas fa-info"></i>  Maklumat yang diberikan haruslah betul dan ruangan bertanda <span class="text-danger">*</span> hendaklah diisi.
                    </p>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-switch">
                                    <input type="checkbox" class="form-check-input" name="is_move" id="is_move">
                                    <label class="form-check-label cursor-pointer" for="is_move" style="font-family: lato; font-size:14px;line-height:14px;margin-left:4px"> Tidak Boleh Bergerak  <i class="fa fa-info-circle spakat-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Kenderaan terlalu tua untuk dipandu / ditarik ke woksyop" id="tip-breakdown"></i></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4">
                            <div class="form-group">
                                ...
                                <input onchange="forceCurrency(this)" style="max-width:130px" type="text" name="earlier_maintenance_cost" id="earlier_maintenance_cost" class="form-control text-end" xearlier_maintenance_cost>
                                <div class="hasErr"></div>
                            </div>
                        </div>
            ...
            <div class="modal-body" style="width:97%">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="form-group">
                                <label for="" class="form-label">No. Siri Pendaftaran Aset  </label>
                                <div class="txt-data ass_dis"><span id="no_siri_pend" class="txt-data ass_dis"></span></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="form-group">
                                <label for="" class="form-label">No.Kodifikasi Nasional  </label>
                                <div class="txt-data ass_dis"><span id="no_lod_na" class="txt-data ass_dis"></span></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="form-group">
                                <label for="" class="form-label">Jumlah Kos Penyenggaraan Terdahulu  </label>
...
<script type="text/javascript">
    ...
    loadAssessmentAccidentVehicle = function() {
        $.get("{{ route('assessment.disposal.vehicle.list') }}", function(result){
            ...
            success: function(isExist) {
                ...
                if(isExist == 1){
                    ...
                    if($('[name="'+key+'"]').parent().find('.hasErr .text-danger').length == 0){
                        ...
                        if (is_move == false){
                            $('#is_move').prop("checked", false);
                        }else{
                            $('#is_move').prop("checked", true);
                        }
    ...
    editAssessmentVehicle = function(vehicle_id, functional){
        ...
        viewVehicle = function(vehicle_id, functional){
            ...
            dataType: 'json',
                success: function(data){
                    ...
                    $('#lokasi_kenderaan').html(data.location);
                    $('#no_siri_pend').html(data.aset_regno);
                    $('#no_lod_na').html(data.nc_no);
                    $('#perolehan_asal').html(data.original_price);
                    $('#kos_terdahulu').html("RM "+data.earlier_maintenance_cost);
                    let is_move = data.is_move;
                        if (is_move == false){
