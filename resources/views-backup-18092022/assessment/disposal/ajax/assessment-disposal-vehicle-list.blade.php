            ...
            @foreach ($vehicleList as $index => $vehicle)
                <tr class="vehicle">
                    @if($hasAssessmentDisposalDetail->hasStatus->code == '01')
                        ...
                        <td class="col-edit" onclick="editAssessmentVehicle({{$vehicle->id}}, 'edit')">
                    ...
                    @if($hasAssessmentDisposalDetail->hasStatus->code == '08')
                    <td>
                        <button type="button" class="btn cux-btn small" data-url="{{route('assessment.checklist-report', ['assessment_type_code' => '06', 'vehicle_id' => $vehicle->id])}}" onclick="viewCheckList(this)">Lihat Senarai</button>
                    </td>
                    @endif
                </tr>
            @endforeach
