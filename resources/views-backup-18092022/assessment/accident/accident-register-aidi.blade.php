...
<head>
    ...
    <script type="text/javascript">
                    ...
                    $('#frm_vehicle input:required').each(function() {
                        ...
                        if ($(this).val() === ''){
                            if($(this).attr('id') == 'vehicle_brand_id'){
                                console.log("Melly:" + whattype);

                            }
                            proceed = false;
                            $('.verify').addClass('dim');

                            //$(this).closest(".hasErr").text(whattype);
                            $(this).next().closest('.hasErr').text(whattype)
                            //$(this).closest(".hasErr").text(whattype);
                            //$(this).closest().filter('.hasErr').text(whattype);
                            //$(this).next().text(whattype)
                        }
                        ...
                        if($(this).find('option:selected').text() == ''){
                            ...
                            proceed = false;
                            $(this).next().text('Sila pilih')
                        }*/

                    });
                }else{
                    alert("2nd form don't exist");
                }
            }
        ...
        function submitVerify(data, report_no, report_dt, driver_name, driver_mykad, driver_phone, plate_no, category_main, list_sub_category_main, list_sub_category_main_type) {
        ...
        <div class="quick-navigation" data-fixed-after-touch="">
            <div class="wrapper" style="position: relative">
                <ul id="tabActive">
                    ...
                    @endif
                    @if ($detail && $detail && in_array($detail->hasStatus->code, ['03','04','05','08']) && auth()->user()->checkRole('07'))
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#frm_verify').on('submit', function(e) {
                ...
                submitVerify(formData, report_no, report_dt, driver_name, driver_mykad, driver_phone, plate_no, category_main, list_sub_category_main, list_sub_category_main_type);
