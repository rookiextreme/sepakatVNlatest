            ...
            <div class="modal-body">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        {{-- <div class="col-xl-2 col-lg-3 col-md-3" style="position: relative">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">Harga Beli <small>RM</small> <i class="fa fa-info-circle spakat-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Harga asal untuk belian bagi kenderaan yang didaftarkan"></i> <span class="text-danger">*</span></label>
                                <input type="text" class="form-control text-end" name="market_price" id="market_price" placeholder="" xplate_no onchange="forceCurrency(this)">
                                <div class="hasErr"></div>
                            </div>
                        </div> --}}
                        <div class="col-xl-2 col-lg-3 col-md-3" style="position: relative">
...
<script type="text/javascript">
    ...
    loadAssessmentcurrvalueVehicle = function() {
        $.get("{{ route('assessment.currvalue.vehicle.list') }}", function(result){
