...
<form class="row" id="frm_cerificate" enctype="multipart/form-data">
    ...
    <div class="col-md-12" id="assessment_currvalue_vehicle_certificate">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="small-title">Maklumat Sijil
                    <div>Nilaian Harga Semasa kenderaan yang telah dinilai</div>
                </div>
                <span>
            ...
            <div class="modal-body" style="width:97%">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-9" >
                            <div class="form-group">
                                <label for="" class="form-label text-dark">Sebab Ubah <span class="text-danger">*</span></label>
...
<script type="text/javascript">
    ...
    loadAssessmentCurrvalueVehicleCertificate = function() {
        $.get("{{ route('assessment.currvalue.vehicle-certificate.list') }}", function(result){
            $('#assessment_currvalue_vehicle_certificate').html(result);
        });
    }
    ...
    editCertificate = function(vehicle_id, assessment_id){
        ...
        $.ajax({
        url: '{{Route("assessment.currvalue.vehicle.getCertificateDetails")}}',
        type: 'get',
        data: {
    ...
    submitEditCertificate = function(data) {
        ...
        $.ajax({
            url: "{{ route('assessment.currvalue.vehicle.editCertificate.save') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                loadAssessmentCurrvalueVehicleCertificate();
            },
