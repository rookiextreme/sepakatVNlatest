        ...
        <div class="row content-row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                ...
                <ul class="menu">
                    ...
                    <li><a href="{{ route('report.report_scheduled_maintenance_performance')}}">Prestasi Penyenggaraan Berkala</a></li>
                    <li><a href="{{ route('report.report_scheduled_repair_performance')}}">Prestasi Pembaikan</a></li>
