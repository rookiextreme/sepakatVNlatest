      ...
      <div class="main-content">
         <section id="perincian" class="tab-content">
            <div class="detailing">
               ...
               @if ($hasForm && !$hasForm->is_research_market == 2)
                  ...
                  <table class="table table-bordered w-100 mb-0" style="border-left: 0px solid black;border-right: 0px solid black;border-bottom: 0px solid black;">
                     <tr style="background-color: gray;">
                        <td class="text-center label-title p-1 m-1">PEMBAIKAN / SERVIS</td>
                        <td class="text-center label-title p-1 m-1">BUTIRAN PEMBAIKAN</td>
                     </tr>
                     @if ($hasForm && $hasForm->is_research_market == 1)
                        ...
                        @endforeach
                     {{-- @elseif ($hasForm && $hasForm->is_research_market == 2) --}}
            ...
            <table class="table table-bordered w-100 mb-0 cellpadding-3" style="border: 1px solid black;border-top: 0px;">
                <tr style="background-color: yellow;">
                    ...
                    @if ($hasForm->repair_method_id == 2 && !$hasForm->is_research_market == 2)
                        <td colspan="2" class="text-center label-title text-uppercase">Lain-lain kerosakan</td>
                     @elseif ($hasForm->is_research_market == 2)
              ...
              <tr>
                  ...
                  <td class="label-title text-uppercase">Nama : {{$hasForm->completedBy ? $hasForm->completedBy->name : '-'}}</td>
              </tr>

              <tr>
                  <td class="label-title w-50 text-uppercase">Jawatan : {{$hasForm->InspectedBy ? $hasForm->InspectedBy->hasRole()->designation : '-'}}</td>
                  <td class="label-title w-50 text-uppercase">Jawatan : {{$hasForm->completedBy ? $hasForm->completedBy->hasRole()->designation : '-'}}</td>
              </tr>
              <tr>
                  ...
                  <td class="label-title w-50 text-uppercase">Tarikh Semak : {{$hasForm->completed_dt ? Carbon\Carbon::parse($hasForm->completed_dt)->format('d F Y') : '-'}}</td>
            </tr>
