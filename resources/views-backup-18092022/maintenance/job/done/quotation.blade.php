      ...
      <div class="main-content">
         ...
         <section id="perincian" class="tab-content">
            <div class="detailing">
               ...
               <table class="table table-bordered w-100">
                   @if($detail->hasExamform->hasQuotation)
                        <tr>
                            <td class="w-25 label-title">NO SEBUTHARGA</td>
                            <td>{{$detail->hasExamform->hasQuotation->quotation_no}}</td>
                        </tr>
                        <tr>
                            <td class="w-25 label-title">NAMA SYARIKAT PEMBEKAL</td>
                            <td>{{$detail->hasExamform->hasQuotation->company_name}}</td>
                        </tr>
                        <tr>
                            <td class="w-25 label-title">TARIKH SEBUTHARGA</td>
                            <td>{{Carbon\Carbon::parse($detail->hasExamform->hasQuotation->quotation_dt)->format('d F Y')}}</td>
                        </tr>
                        <tr>
                            <td class="w-25 label-title">TARIKH SST</td>
                            <td>{{Carbon\Carbon::parse($detail->hasExamform->hasQuotation->sst_dt)->format('d F Y')}}</td>
                        </tr>
                        <tr>
                            <td class="w-25 label-title">JUMLAH HARGA (RM)</td>
                            <td>{{number_format($detail->hasExamform->hasQuotation->total_price, 2)}}</td>
                        </tr>
                        <tr>
                            <td class="w-25 label-title">TARIKH SIAP</td>
                            <td>{{Carbon\Carbon::parse($detail->hasExamform->hasQuotation->end_dt)->format('d F Y')}}</td>
                        </tr>
                        @else
                        <tr>
