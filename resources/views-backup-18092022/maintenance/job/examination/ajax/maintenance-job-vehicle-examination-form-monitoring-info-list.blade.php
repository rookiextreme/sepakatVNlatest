    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            @foreach ($monitoringInfoList as $index => $monitorInfo)
                <tr data-ref-info-code="{{$monitorInfo->hasRefInfo->code}}">
                    <td class="align-top">{{$monitoringInfoList->firstItem() + $index}}</td>
                    <td class="align-top">
                        <div data-monitorInfo="{{$monitorInfo}}" class="btn-group">
                            <span onclick="editMonitorInfo(this)" class="btn cux-btn small"> <i class="fal fa-pen-nib"></i></span>
                            <span onclick="delMonitorInfo({{$monitorInfo->id}})" class="btn cux-btn small"> <i class="fal fa-trash-alt"></i></span>
                        </div>
                    </td>
