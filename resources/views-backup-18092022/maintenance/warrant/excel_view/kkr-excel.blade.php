<div class="detailing" style='overflow-x: scroll;'>
    <table><tr><td  colspan='12' > <div class="small-title" style='margin-bottom:15px'>KKR- PENYATA KEMAJUAN PERBELANJAAN BULAN {{strtoupper($monthDesc[$selectedMonth])}} {{$selectedYear}}</div></td></tr></table>
    <table>
        <tr>
