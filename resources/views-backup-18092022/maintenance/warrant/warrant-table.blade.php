            ...
            <form id='divUpdateExpenseAdjusmentForm'>
                ...
                <div class='row'>
                    <div class='col-sm-6 col-12'>
                        ...
                        <div class="form-group">
                            <label for="" class="form-label text-dark">JUMLAH (RM) </label>
...
<script type="text/javascript">
    ...
    function addAdjustment(){
        ...
        $.get('{{route('maintenance.warrant.add-warrant-adjustment')}}',{'id':id,'year':{{$selectedYear}}  ,'month': {{$selectedMonth}} , 'workshop_id' : workshopId ,'waran_type_id':warrantTypeId ,'osol_type_id':osolTypeId , 'amount':amount ,'note':note,'expense_dt':expenseDt}, function(res){
