...
<div style="max-width:500px;font-size:12px;font-family:Arial, Helvetica, sans-serif">
    ...
    <br><br>
    Proses penilaian telah selesai bagi kenderaan No. Pendaftaran <b>{{$details['plate_no']}}</b>.
    Bagi pemohon bernama, {{$details['applicant_name']}}, sila log masuk untuk memuat turun Sijil Kenderaan Baharu.
    </div>
<br/>
<br/><br/><br/>
