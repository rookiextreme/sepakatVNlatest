<script type="text/javascript">
    ...
    function getVehicleType_{{$field_name}}(currentPage){
        page = currentPage;
        $.get("{{route('ajax.lookup.vehicleType')}}", {field_name: "{{$field_name}}", search: search, page: page, filter_by_role: "{{$filter_by_role}}"},  function(data){
