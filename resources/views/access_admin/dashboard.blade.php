                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        ...
                        <div class="info-box" id="box-maintenanance-warrants" style="padding-bottom:10px">
                            ...
                            @php
                                ...
                                $warranDetails = DB::select('select a.month, b.code, c.code AS osos_code, sum(COALESCE(a.allocation,0)) AS allocation, sum(COALESCE(a.expense, 0)) As expense, SUM(a.total_allocation) as sum_total_allocation, sum(a.expense) as carry_expense from maintenance.warrant_detail a
                                                ...
                                                if($warranDetail->month == 12){
                                                    ...
                                                    switch ($warranDetail->osos_code) {
                                                        case '01':
                                                            ...
                                                            break;
                                                        case '02':
                                                            $mhpvAllocation28000 += $warranDetail->sum_total_allocation;
                                                            break;
                                                    }
                                                }
                                ...
                                if($mhpvAllocation26000 > 0 ){
                                    $mhpvPerc26000 = $mhpvExpense26000 < $mhpvAllocation26000 && $mhpvAllocation26000 > 0 ? number_format(($mhpvExpense26000/$mhpvAllocation26000) * 100, 2) : 0;
                                }else{
                                    $mhpvPerc26000 = 0;
                                }

                                if($mhpvAllocation28000 > 0 ){
                                    $a = (($mhpvExpense28000/$mhpvAllocation28000) * 100) * pow(10, 2);
                                    $b = floor($a);
                                    $c = pow(10, 2);
                                    $mhpvPerc28000 = $mhpvExpense28000 < $mhpvAllocation28000 && $mhpvAllocation28000 > 0 ? $b/$c : 0;
                                }else{
                                    $mhpvPerc28000 = 0;
                                }
