...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Arkib</li>
    </ol>
</nav>
<div class="btn-group">
    ...
    jQuery(document).ready(function() {
        ...
        .DataTable({
            ...
            "columns": [
                    ...
                    { "data": "brand_name", "autoWidth": true },
            ...
            "columnDefs":[
                ...
                },
                {
                    ...
                    targets: 8, render:function(data){
                        ...
                        var url = '{{route("vehicle.saman.rekod")}}?vehicle_id='+data.id;
                        @if(Auth()->user()->roleAccess()->code == '04')
                            url = '{{route("vehicle.saman.rekodbayar")}}?vehicle_id='+data.id;
                        @endif

                        return '<a class="badge bg-green text-white" href="'+url+'">'+data.total_summon+'</a>';
                    }
                }
            ],
            select: true,
