        ...
        <div class="col-xl-3 col-lg-3 col-Umd-3 col-sm-3 col-12 hailait">
            <ul class="menu">
                ...
                @elseif(Auth::user()->roleAccess()->code == '03')
                 ...
                 @else 
                @endif --}}
                <li><i class="fal fa-list-ul"></i> <a href="#" onclick="openPgInFrame('{{ route('report.report_vehicle_jkr_by_workshop_ownership')}}')">Ringkasan Kenderaan Mengikut JKR Woksyop</a></li>
                <li><i class="fal fa-list-ul"></i> <a href="#" onclick="openPgInFrame('{{ route('report.report_vehicle_jkr_by_cat_type', ['owner_type_code' => '01'])}}')">Pecahan Kenderaan Mengikut Jenis (Milik JKR Persekutuan)</a></li>
                <li><i class="fal fa-list-ul"></i> <a href="#" onclick="openPgInFrame('{{ route('report.report_vehicle_jkr_by_cat_type', ['owner_type_code' => '02'])}}')">Pecahan Kenderaan Mengikut Jenis (Milik Negeri)</a></li>
                </ul>
        </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 hailait">
            ...
            <ul class="menu">
                ...
                <li class="row">
                    ...
                    <div class="col ps-0 col-negeri"><i class="fal fa-map-marked-alt"></i> <a href="{{ route('report.report_map_peninsular')}}?negeri=sarawak">Sarawak</a></div>
