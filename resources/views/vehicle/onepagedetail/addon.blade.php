    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                ...
                @if (!empty($is_display) && ($is_display == 1))
                    <div class="text-capitalize theme-color-text">
                        {{isset($detail['harga_perolehan']) ? $detail['harga_perolehan'] : ""}}
                    </div>
                @else
                <input type="text" class="form-control" autocomplete="off" name="hargaPerolehan" value="{{isset($detail['harga_perolehan']) ? (float)$detail['harga_perolehan'] : ""}}">
                @endif
            </div>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                ...
                <div wire:ignore class="input-group date" id="manufactureDate">
                        ...
                        value="{{isset($detail['manufacture_year']) ? Carbon\Carbon::parse($detail['manufacture_year'])->format('Y'): null}}"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        roadtax_dt_container.datepicker('setEndDate', new Date());
