            ...
            <div class="col-md-8">
                <fieldset>
                    ...
                    <div class="row box-info">
                        ...
                        <div class="col-xl-8 col-lg-6 col-md-6 col-sm-6 col-6 mytext">{{$vehicle->hasAssignedVehicle ? $vehicle->hasAssignedVehicle->no_pendaftaran : '-'}}</div>
                    </div>
                    <div class="row box-info">
                    ...
                    <div class="row box-info">
                        ...
                        <div class="col-xl-8 col-lg-6 col-md-6 col-sm-6 col-6 mytext">{{$vehicle->hasAssignedVehicle && $vehicle->hasAssignedVehicle->hasCategory() ? $vehicle->hasAssignedVehicle->hasCategory()->name:''}} > {{$vehicle->hasAssignedVehicle && $vehicle->hasAssignedVehicle->hasSubCategory()? $vehicle->hasAssignedVehicle->hasSubCategory()->name:''}}</div>
                    </div>
                    <div class="row box-info">
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 rlabel">Jenis</div>
                        <div class="col-xl-8 col-lg-6 col-md-6 col-sm-6 col-6 mytext">{{$vehicle->hasAssignedVehicle && $vehicle->hasAssignedVehicle->hasSubCategoryType() ? $vehicle->hasAssignedVehicle->hasSubCategoryType()->name:''}}</div>
                    </div>
                    <div class="row box-info">
