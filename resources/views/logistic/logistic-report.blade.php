...
<body class="content">
<div class="mytitle">Laporan & Analisis <span>Pengurusan Logistik</span></div>
<p>&nbsp;</p>
...
<div class="row content-row">
    <div class="col-xl-3 col-lg-3 col-Umd-3 col-sm-3 col-12 hailait">
        <ul class="menu">
            <li>Pecahan mengikut Komposisi</li>
            ...
            <li><i class="fal fa-chart-pie"></i> <a href="#">Minyak</a></li>
            <li><i class="fal fa-chart-pie"></i> <a href="#">Touch 'N Go</a></li>
        </ul>
    </div>
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
        <ul class="menu">
            <li>Permohonan Baharu</li>
            <li><i class="fal fa-chart-line"></i> <a href="{{ route('report.report_compositions')}}">Mengikut Tahun / Bulan</a></li>
            {{-- <li><i class="fal fa-chart-line"></i> <a href="{{ route('report.logistic_compositions')}}">Mengikut Tahun / Bulan</a></li> --}}
        </ul>
        <ul class="menu">
        </ul>
    </div>
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 hailait">
        <ul class="menu">
            <li>Jumlah Mengikut Lokasi</li>
            <li><i class="fal fa-map-marked-alt"></i> <a href="{{ route('report.report_map_peninsular')}}">Negeri</a></li>
            <li><i class="fal fa-map-marked-alt"></i> <a href="{{ route('report.report_map_state')}}">Daerah</a></li>
        </ul>
    </div>
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
        <ul class="menu">
            <li>Senarai Penuh</li>
            <li><i class="fal fa-list-ul"></i> <a href="{{ route('report.report-logistic-booking-list')}}">Senarai Permintaan</a></li>
        </ul>
    </div>
</div>
<div class="row">
...
<div class="row content-row">
    ...
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
        <ul class="menu">
            <li>Senarai Penuh</li>
            <li><i class="fal fa-list-ul"></i> <a href="{{ route('report.report-logistic-disaster-list') }}">Senarai Tempahan</a></li>
            <li><i class="fal fa-list-ul"></i> <a href="{{ route('logistic.disasterready.vehicle.list') }}">Senarai Kenderaan</a></li>
            <li><i class="fal fa-list-ul"></i> <a href="{{ route('report.report.disaster_ready.by_state_vtypes') }}">RIngkasan Kenderaan Siap Siaga</a></li>
        </ul>
    </div>
</div>
<script>
