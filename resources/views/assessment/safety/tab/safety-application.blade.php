...
<form class="row" id="frm_application" enctype="multipart/form-data">
    ...
    {{-- <input type="hidden" name="ttl_vehicle" id="ttl_vehicle" value="{{$detail->ttl_vehicle}}"> --}}
    <fieldset>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-5">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01','02']) || auth()->user()->isAdmin())
                    ...
                    onchange="forceCaps(this);" value="{{$detail ? $detail->applicant_name : strtoupper(auth()->user()->name)}}">
                @else
            ...
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01','02']) || auth()->user()->isAdmin())
                    ...
                    onkeyup="this.value = !isNaN(this.value) ? this.value : '';" maxlength="50">
                @else
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01','02']) || auth()->user()->isAdmin())
                    <div class="input-group">
                        <input type="text" class="form-control" id="department_name" name="department_name" value="{{$detail ? $detail->department_name : auth()->user()->detail->department_name}}" onchange="forceCaps(this);">
                    </div>
                @else
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01','02']) || auth()->user()->isAdmin())
                    <div class="input-group">
                        <textarea class="form-control" name="address" id="address" onchange="forceCaps(this);" cols="30" rows="3" maxlength="200">{{$detail ? $detail->address : auth()->user()->detail->address}}</textarea>
                    </div>
                @else
    ...
    <fieldset>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                @else
                    <div class="">{{$detail && $detail->hasWorkShop ? $detail->hasWorkShop->desc : null}}</div>
                @endif
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-7">
                        <div class="input-group date form_datetime" id="date1Container" data-date="{{$detail && $detail->appointment_dt1 ? $detail->appointment_dt1 : ''}}" data-date-format="dd M yyyy">
                            <input class="form-control appointment_date" autocomplete="false" size="16" id="input_date_1" type="text"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-7">
                        <div class="input-group date form_datetime" id="date2Container" data-date="{{$detail && $detail->appointment_dt2 ? $detail->appointment_dt2 : ''}}" data-date-format="dd M yyyy">
                            <input class="form-control appointment_date" autocomplete="false" size="16" id="input_date_2" type="text"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-7">
                        <div class="input-group date form_datetime" id="date3Container" data-date="{{$detail && $detail->appointment_dt3 ? $detail->appointment_dt3 : ''}}" data-date-format="dd M yyyy">
                            <input class="form-control appointment_date" autocomplete="false" size="16" id="input_date_3" type="text"
            ...
            @if($detail)
                @if($is_myApp)
                    @if($detail->hasStatus->code == '01')
                        {{-- <button class="btn btn-link" type="submit"><i class="fal fa-save fa-lg"></i> Simpan</button> --}}
                    ...
                    @if($detail->hasStatus->code == '01' || auth()->user()->isAdmin())
                        <button class="btn btn-link" data-mode="save" xaction="save" type="button"><i class="fal fa-save"></i> Simpan</button>
                    @endif
                @endif
            @else
                <button class="btn btn-link" type="submit"><i class="fas fa-arrow-right fa-lg"></i> Seterusnya</button>
            @endif
        </div>
    </div>
    <p>&nbsp;</p>
...
<script type="text/javascript">
    ...
    function submitApplication(data) {
        ...
        $('[xaction="save"]').on('click', function(e){
            e.preventDefault();

            let formData = new FormData($('#frm_application')[0]);
