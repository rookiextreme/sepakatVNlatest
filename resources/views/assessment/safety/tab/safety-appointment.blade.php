                    ...
                    <div class="form-group">
                        ...
                        @if($detail && $detail->hasStatus->code == '02' && auth()->user()->isAssistEngineerAssessment())
                            <select name="appointment_dt" id="appointment_dt">
                                ...
                                @endif
                                <option {{$detail && $detail->is_other_app_dt ? 'selected' : ''}} value="other_appointment_dt" id="other_appointment">Pilihan Lain</option>
                            </select>
                        @else
                ...
                {{-- <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5 col-12" style="min-width:270px;display: {{ $detail && $detail->is_other_app_dt ? '' : 'none'}}" id="other_datetime_container">
                    ...
                    <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12" style="display: {{ $detail && $detail->is_other_app_dt ? '' : 'none'}}" id="other_datetime_container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" id="add_new_time">
...
let new_date = $('#other_appoinment_dt').val();
let new_time = $('#time_other').val();
let input_other_date = $('#input_other_date').val();
...
saveSilent = function(){
    ...
    $(document).ready(function(){
        ...
        $("#frm_apppointment_vehicle #appointment_dt").select2({
            width: '100%',
            theme: "classic"
        });

        $("#frm_apppointment_vehicle #workshop_id").select2({
            width: '100%',
            theme: "classic"
        });
        ...
        $('#time_other, other_appoinment_dt' ).on('change', function(e){
            e.preventDefault();
        ...
        $('#appointment_dt').on('change', function(e){
            ...
            if(this.value){
                if(this.value == 'other_appointment_dt'){
                    if((new_date == null || new_date == '') && (new_time == null || new_time == '')){
                        proceed_appointment_container.hide();
                    }
                    else{
                        proceed_appointment_container.show();
