...
<form id="frm_application" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-5">
                ...
                @else
                    <div class="txt-data ass_new">{{$detail ? $detail->applicant_name : strtoupper(auth()->user()->name)}}</div>
                @endif
            </div>
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-9">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01']) || auth()->user()->isAdmin())
                    ...
                    onkeyup="this.value = !isNaN(this.value) ? this.value : ''; " maxlength="11">
                @else
                    <div class="txt-data ass_new">{{$detail ? $detail->phone_no : auth()->user()->detail->telbimbit}}</div>
                @endif
            </div>
        </div>
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-sm-4 col-12">
                ...
                @else
                    <div class="txt-data-small ass_new">{{$detail ? $detail->email : auth()->user()->email}}</div>
                @endif
            </div>
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-sm-4 col-9">
                ...
                @else
                    <div class="txt-data-small ass_new">{{$detail ? $detail->ic_no : auth()->user()->identity_no}}</div>
                @endif
            </div>
        </div>
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-6">
                ...
                @else
                    <div class="txt-data ass_new">{{$detail && $detail->hasAgency ? $detail->hasAgency->desc : null}}</div>
                @endif
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                @else
                    <div class="txt-data ass_new">{{$detail ? $detail->department_name : null}}</div>
                @endif
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01']) || auth()->user()->isAdmin())
                    <div class="input-group">
                        <input type="text" class="form-control" id="hod_title" placeholder="KETUA PENGARAH" name="hod_title" onchange="this.value = this.value.toUpperCase()" value="{{$detail ? $detail->hod_title : auth()->user()->detail->hod_title}}">
                    </div>
                @else
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                ...
                @else
                    <div class="txt-data ass_new">{{$detail ? $detail->address : null}}</div>
                @endif
            </div>
            <div class="col-xl-6 col-lg-6 col-md-7 col-sm-6 col-12">
                <div class="row">
                    <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-4">
                        ...
                        @else
                            <div class="txt-data ass_new">{{$detail ? $detail->postcode : null}}</div>
                        @endif
                    </div>
                    <div class="col-xl-5 col-lg-7 col-md-6 col-sm-12 col-8">
                            ...
                            <div class="input-group">
                                <select class="form-control form-select" id="state_id" name="state_id" >
                                    ...
                                    @foreach ($state_list as $state)
                                        <option {{($detail && $detail->state_id  == $state->id) || (auth()->user()->detail->hasState && auth()->user()->detail->hasState->id == $state->id) ? 'selected'  : ''}} value="{{$state->id}}">{{$state->desc}}</option>
                                    @endforeach
                                </select>
                                {{-- <input type="text" class="form-control" name="state_id" id="state_id" value="{{$detail ? $detail->state_id : null}}"> --}}
                            </div>
                        @else
                            <div class="txt-data ass_new">
                                @foreach ($state_list as $state)
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                <div class="txt-data ass_new thin-underline" style="height:52px">
                ...
                @else
                    <div class="txt-data ass_new">{{$detail && $detail->hasWorkShop ? $detail->hasWorkShop->desc : null}}</div>
                @endif
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12">
                ...
                <div class="mobile-explanation">
                    Anda boleh memilih beberapa tarikh dan masa yang sesuai untuk anda, dan kami cuba untuk memilih mana-mana tarikh yang kosong mengikut pilihan anda. Namun, sekiranya tiada slot yang kosong, kami akan berikan slot mengikut kekosongan.
                </div>
                <div class="row">
                    <div class="col-12">
                        <label class="sub-label text-dark">Pilihan Pertama <span class="text-danger">*</span></label>
                    </div>
                    @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01']) || auth()->user()->isAdmin())
                    <div class="col-xl-7 col-7">
                        <div class="input-group date form_datetime" id="date1Container" data-date="{{$detail && $detail->appointment_dt1 ? $detail->appointment_dt1 : ''}}" data-date-format="dd M yyyy">
                            ...
                            value="{{$detail && $detail->appointment_dt1 ? Carbon\Carbon::parse($detail->appointment_dt1 )->format('d M Y') : ''}}" placeholder="Tarikh 1" onkeypress="return false;" readonly="readonly" required>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-7">
                        <div class="input-group date form_datetime" id="date2Container" data-date="{{$detail && $detail->appointment_dt2 ? $detail->appointment_dt2 : ''}}" data-date-format="dd M yyyy">
                            ...
                            value="{{$detail && $detail->appointment_dt2 ? Carbon\Carbon::parse($detail->appointment_dt2 )->format('d M Y') : ''}}" placeholder="Tarikh 2" readonly="readonly" onkeypress="return false;" >
                            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-7">
                        <div class="input-group date form_datetime" id="date3Container" data-date="{{$detail && $detail->appointment_dt3 ? $detail->appointment_dt3 : ''}}" data-date-format="dd M yyyy">
                            ...
                            value="{{$detail && $detail->appointment_dt3 ? Carbon\Carbon::parse($detail->appointment_dt3 )->format('d M Y') : ''}}" placeholder="Tarikh 3" readonly="readonly" onkeypress="return false;" >
                            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
    ...
    <div class="paper">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-5">
                <label for="" class="form-label text-dark">Nama Pemohon</label>
                <div class="txt-data ass_new">{{$detail ? $detail->applicant_name : strtoupper(auth()->user()->name)}}</div>
            </div>
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-6">
                <label for="" class="form-label text-dark">No Telefon</label>
                <div class="txt-data ass_new">{{$detail ? $detail->phone_no : auth()->user()->detail->telbimbit}}</div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-sm-4 col-6">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                <label for="" class="form-label text-dark">Jabatan / Agensi</label>
                <div class="txt-data ass_new">{{$detail ? $detail->department_name : null}}</div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                <label for="" class="form-label text-dark">Ketua Jabatan (Gelaran)</label>
                <div class="txt-data ass_new">{{$detail ? $detail->hod_title : null}}</div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <label for="" class="form-label text-dark">Alamat</label>
                <div class="txt-data ass_new">{{$detail ? $detail->address : null}}</div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-7 col-sm-6 col-12">
                <div class="row">
                    <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-3">
                        <label for="" class="form-label text-dark">Poskod</label>
                        <div class="txt-data ass_new">{{$detail ? $detail->postcode : null}}</div>
                    </div>
                    <div class="col-xl-5 col-lg-7 col-md-6 col-sm-12 col-9">
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                    ...
                    @endif
                    <label for="" class="form-label text-dark">Woksyop Pilihan</label>
                    <div class="txt-data ass_new">{{$detail && $detail->hasWorkShop ? $detail->hasWorkShop->desc : null}}</div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                    <label class="form-label text-dark">Cadangan Tarikh & Masa Temujanji</label>
                    <div class="row">
                        <div class="col-12">
                            <div class="txt-data ass_new">{{$detail && $detail->appointment_dt1 ? Carbon\Carbon::parse($detail->appointment_dt1 )->format('d M Y - g:i A') : ''}}</div>
                        </div>
                        @if($detail && $detail->appointment_dt2)
                        <div class="col-12">
                            <div class="txt-data ass_new">{{$detail && $detail->appointment_dt2 ? Carbon\Carbon::parse($detail->appointment_dt2 )->format('d M Y - g:i A') : ''}}</div>
                        </div>
                        @endif
                        @if($detail && $detail->appointment_dt3)
                        <div class="col-12">
                            <div class="txt-data ass_new">{{$detail && $detail->appointment_dt3 ? Carbon\Carbon::parse($detail->appointment_dt3 )->format('d M Y - g:i A') : ''}}</div>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            @if($detail)
                @if($is_myApp)
                    @if($detail->hasStatus->code == '01')
                        <a id="" {{$detail->hasVehicle->count()>0 ? '':'disabled'}} class="btn btn-module verify" data-id="{{$detail ? $detail->id : null}}">Hantar</a>
                    @endif
