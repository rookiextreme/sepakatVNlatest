...
<form class="row" id="frm_vehicle_assessment" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-12" id="assessment_new_vehicle_assessment">
...
<div class="modal fade" id="assessmentNewVehicleVerificationModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="assessmentNewVehicleVerificationModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    promptSubmitForVerificationModal = function(){
        $('#assessmentNewVehicleVerificationModal').modal('show');
    }

    submitForVerification = function(){
        $.post("{{ route('assessment.new.verification') }}", {
            '_token': '{{ csrf_token() }}'
        }, function(result){
    ...
    loadAssessmentNewVehicleAssessment = function() {
        $.get("{{ route('assessment.new.vehicle-assessment.list') }}", function(result){
            $('#assessment_new_vehicle_assessment').html(result);
        });
    }
