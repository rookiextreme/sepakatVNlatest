                        ...
                        <table class="table-custom stripe no-footer">
                            ...
                            <tbody class="no-footer">
                                ...
                                <tr class="must-answer">
                                    ...
                                    <td>
                                        <textarea style="resize: none;" name="form_note_lvl2_component_id_{{$AssessmentFormCheckLvl2->id}}" id="form_note_lvl2_component_id_{{$AssessmentFormCheckLvl2->id}}" rows="2" class="form-control"  onchange="summarizeThisForm()">{{$AssessmentFormCheckLvl2->note}}</textarea>
                                    </td>
                                ...
                                <tr class="must-answer" id="form_note_lvl3">
                                    <td>
                                        <div class="form-switch">
                                    ...
                                    <td>
                                        <textarea style="resize: none;" name="form_note_lvl3_component_id_{{$AssessmentFormCheckLvl3->id}}" id="form_note_lvl3_component_id_{{$AssessmentFormCheckLvl3->id}}" rows="2" class="form-control"  onchange="summarizeThisForm()">{{$AssessmentFormCheckLvl3->note}}</textarea>
                                    </td>
                                    <div class="hasErr"></div>
