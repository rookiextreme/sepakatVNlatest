...
$newAssessmentDAO = new AssessmentNewDAO();
...
$totalCompleted = 0;
$totalRejected = 0;
$myjob_total = $newAssessmentDAO->list($currentReq->merge(
    [
        'status_code' => 'my_job',
        'mode' => 'count'
    ]));
            ...
            <div class="col-xl-6 col-lg-8 col-md-8 col-sm-6 col-12">
                <div class="dropdown inline" style="display: inline">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item {{$status_code == 'my_job' ? 'active':''}}" onclick="parent.openPgInFrame('{{route('assessment.new.list', ['status_code' =>  'my_job'])}}')">Tindakan Saya
                ...
                <tbody id="sortable">
                    ...
                    <tr>
                        ...
                        <td class="col-edit">
                            <br>
                            <div class="btn-group">
                                    <button class='btn cux-btn' onclick="parent.openPgInFrame('{{route('assessment.new.register', [ 'id' =>  $new->id, 'tab' => $tab, 'status_code' =>$status_code])}}')"><i class="fa fa-pencil-alt"></i></button>
                        ...
                        <td><a href="{{route('assessment.new.register', [ 'id' =>  $new->id, 'tab' => $tab, 'status_code' =>$status_code ])}}">{{$new->ref_number}}</a></td>
                        <td><a href="{{route('assessment.new.register', [ 'id' =>  $new->id, 'tab' => $tab, 'status_code' =>$status_code ])}}">{{$new->applicant_name}}</a></td>
                        <td>{{$new->phone_no}}</td>
