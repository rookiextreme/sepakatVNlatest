...
<div class="table-responsive">
    {{-- <table id="fleet-ls" class="table display compact stripe hover compact table-bordered"> --}}
        ...
        <thead>
            ...
            <th style="width:70px">No Pendaftaran</th>
        ...
        <tbody>
            ...
            @foreach ($vehicleList as $index => $vehicle)
                <tr>
                    ...
                    <td>{{$vehicle->hasCategory ? $vehicle->hasCategory->name : ''}} <small>{{$vehicle->hasSubCategory ? '> '.$vehicle->hasSubCategory->name : ''}}</small></td>
                    ...
                    <td class="text-center">
                        ...
                        <div class="d-flex justify-content-center">
                                ...
                                <button style="height: 30px;"
                                    ...
                                    onclick="generateFormExaminationEvaluate({{$vehicle->id}}, '01', '{{$status_code}}')"> {{$vehicle->app_datetime  ? 'Tukar': 'Semak'}}</button>
...
{{$vehicleList->links('pagination.ajax-default', [
    'targetDivList' =>  '#assessment_new_vehicle_evaluation',
    'params' => $params
])}}
