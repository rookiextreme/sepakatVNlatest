...
<div class="main-content">
    ...
    @php
        ...
        $overall_total_fleet_in_safety_assess = 0.0;
        $overall_total_fleet_in_safety_assess_done = 0.0;
    @endphp
                ...
                @if (count($list) > 0)
                    @foreach ($list as $index => $branch)
                        @php
                            ...
                            if(isset($branch['total_fleet_in_safety_assess_done'])){
                                if($branch['total_fleet_in_safety_assess_done'] != 0 && $branch['total_fleet_in_safety_assess'] != 0){
                                    $overall_total_fleet_in_safety_assess += $branch['total_fleet_in_safety_assess'];
                                    $overall_total_fleet_in_safety_assess_done += $branch['total_fleet_in_safety_assess_done'];
                                    $percentage_assessment_compeleted = ($branch['total_fleet_in_safety_assess_done'] / $branch['total_fleet_in_safety_assess']) * 100;
                                }
                            }
                        ...
                        <tr>
                            ...
                            <td class="text-end" style="border=2">{{isset($branch['total_fleet_in_safety_assess']) ? $branch['total_fleet_in_safety_assess'] : 0}}</td>
                            <td class="text-end" style="border=2">{{isset($branch['total_fleet_in_safety_assess_done']) ? $branch['total_fleet_in_safety_assess_done'] : 0}}</td>
                            <td class="text-end" style="border=2">{{$percentage_assessment_compeleted}}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td colspan="2" style="border=2">Jumlah</td>
                        <td class="text-end" style="border=2">{{$overall_total_fleet_in_safety_assess}}</td>
                        <td class="text-end" style="border=2">{{$overall_total_fleet_in_safety_assess_done}}</td>
