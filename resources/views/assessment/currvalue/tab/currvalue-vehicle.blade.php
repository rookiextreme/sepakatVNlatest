...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if(hasData){
                    ...
                    let no_year = hasData.has_no_year_manufactured;
                    if (no_year == true){
    ...
    $('#plate_no').on({
        ...
        addAssessmentVehicle = function(){
            ...
            add_vehicle.show();
            edit_vehicle.hide();
            addAssessmentVehicleModal.find('#can_move').prop('checked', false);
            addAssessmentVehicleModal.find('#cannot_move').prop('checked', false);
