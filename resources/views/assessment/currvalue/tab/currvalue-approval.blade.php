...
<form class="row" id="frm_approval" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-12" id="assessment_currvalue_vehicle_approval">
            ...
            <div class="row">
                <div class="col-md-12 mt-2 mb-2">
                    <div class="form-group center">
                        {{-- <span class="btn btn-module" onclick="prompAssessmentcurrvalueApproveModal()">Hantar</span> --}}
...
{{-- <div class="modal fade" id="assessmentcurrvalueApproveModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="assessmentcurrvalueApproveModalLabel" aria-hidden="true">
...
<div class="modal fade modal-asking" id="assessmentcurrvalueApproveModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="assessmentcurrvalueApproveModalLabel" aria-hidden="true">
    <div class="modal-dialog">
...
<script type="text/javascript">
    ...
    prompAssessmentcurrvalueApproveModal = function(){
        $('#assessmentcurrvalueApproveModal').modal('show');
    }

    loadAssessmentCurrvalueVehicleApproval = function() {
        let data ={
            'status_code': '{{$status_code}}'
        }
        $.get("{{ route('assessment.currvalue.vehicle-approval.list', ['page' => $prev_page]) }}", data, function(result){
            $('#assessment_currvalue_vehicle_approval').html(result);
        });
    }
    ...
    assessmentVehicleApprove = function(self){
        ...
        $.post('{{route('assessment.currvalue.approve')}}', {
            '_token': '{{ csrf_token() }}'
        }, function(response){
    ...
    formApprovalEngineer =  function(data){
        $.ajax({
            url: "{{ route('assessment.currvalue.approval') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
    ...
    $(document).ready(function(){
        loadAssessmentCurrvalueVehicleApproval();
