    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                ...
                @else
                <a href="{{ route('assessment.currvalue.register', [
                    'id' => Request('assessment_id'),
                    'tab' => 4,
                    'status_code' => $status_code,
                ]) }}">Penilaian Harga Semasa </a>
                @endif
            </li>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="btn-group" id="transmission" xname="transmission" style="margin-top:1px">
                                        <span data-trans="Manual" id="transmisi_manual" class="btn cux-btn bigger {{$AssessmentCheckListDetail->transmission == "Manual" ? 'active' : ''}}" onchange="summarizeThisForm()">Manual</span>
                                        <span data-trans="Automatik" class="btn cux-btn bigger {{$AssessmentCheckListDetail->transmission == "Automatik" ? 'active' : ''}}" id="transmisi_auto" onchange="summarizeThisForm()">Automatik</span>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control form-select" id="fuel_type_id" name="fuel_type_id" onchange="summarizeThisForm()">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="total_seat" style="width: 50px" value="{{$AssessmentCheckListDetail->total_seat == null ? 4 : $AssessmentCheckListDetail->total_seat}}" onchange="summarizeThisForm()">
