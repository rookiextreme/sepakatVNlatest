        ...
        <tbody>
            @foreach ($vehicleList as $index => $vehicle)
                <tr>
                    ...
                    <td style="text-transform: uppercase">{{$vehicle->hasCategory->name}} > {{$vehicle->hasSubCategory? $vehicle->hasSubCategory->name : ''}}</td>
                    ...
                    <td class="text-center" style="text-transform: uppercase;">
                        ...
                        <div class="btn-group">
                            <span
                                ...
                                onclick="generateFormExaminationcurrvalue({{$vehicle->id}}, '05')"> {{$vehicle->app_datetime ? 'Tukar': 'Semak'}}</span>
                        </div>
                        @endif --}}
...
{{$vehicleList->links('pagination.ajax-default', [
   'targetDivList' =>  '#assessment_currvalue_vehicle_assessment',
   'params' => $params
])}}
