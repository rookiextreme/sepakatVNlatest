                    ...
                    <td class="text-center">
                        @if($vehicle->hasAssessmentVehicleStatus->code == '06')
                            <div class="btn-group">
                                ...
                                href="{{route('jasperReport', ['format' => 'pdf', 'title' => 'Sijil Harga Semasa', 'report_name' => 'assessment_certificate_currvalue', 'table_name' => 'assessment_currvalue', 'vehicle_id' => $vehicle->id])}}",
                                >
