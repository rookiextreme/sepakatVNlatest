...
<body class="content">
    <div class="mytitle">Penilaian Harga Semasa</div>
        ...
        <form class="form-submit" id="the_form">
            <div class="btn-group">
                ...
                @if ($AccessMaintenance->mod_fleet_d == 1)
                    <button data-bs-toggle="modal" data-bs-target="#maintenanceJobDelModal" id="delete_all" disabled class="btn cux-btn bigger" type="button"><i class="fal fa-trash-alt"></i> Hapus</button>
                @endif
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group dropend">
                                    {{-- <button type="button" class="btn cux-btn" onClick=""><i class="fa fa-pencil-alt"></i></button> --}}
                                </div>
                            </td>
                            <td></td>
                            <td></td>
    ...
    <script>
        ...
        function selectVehicle(vehicle_id, vehicle_no){
            window.location.href = "{{route('maintenance.job.register')}}?vehicle_id="+vehicle_id;
        }
