...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       /* var inputs = $('#frm_vehicle').find('input[type="text"], input[type="email"]');
        ...
        $.ajax({
            url: "{{ route('assessment.accident.vehicle.checkExistRegNumber') }}",
            type: 'post',
            data: {
                vehicle_id: vehicle_id,
                plate_no: plate_no,
            ...
            success: function(res) {
                ...
                if(hasData){
                    console.log("hasdata");
                    $('#vehicle_brand_id').val(hasData.vehicle_brand_id).trigger("change");
                    if(hasData.model_name){
                    ...
                    $('#category_main').val(hasData.category_id).trigger("change");
                    addBtn.prop('disabled', false);
                }
