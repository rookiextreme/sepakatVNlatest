@php
    ...
    $vehicleDetails = AssessmentGovLoanVehicle::find($vehicle_id);
...
<body class="content">
<div class="top-fix">
    <div class="mytitle" onclick="summarizeThisForm()">Penilaian <span>Pinjaman Kerajaan</span></div>
    ...
    <form id="frm_examination_achievement_vehicle">
        ...
        <div class="row paper" id="assess-form">
            <div class="col-xl-12 col-lg-12 col-md-12 col-12" style="max-width:1300px">
                ...
                <div class="row thin-topline mt-4" id="SYOR" style="{{auth()->user()->isForemenAssessment() ? 'display: none':'';}}">
                    <div class="col-xl-3 col-lg-3 col-md-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" onchange="forceCurrency(this);calculateCurrentEstimate(this)" class="form-control text-end" name="original_price" id="original_price" value="{{number_format($vehicleDetails->original_price, 2, '.', ',')}}" placeholder="">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" onchange="forceCurrency(this);tempohBerekonomi();autoCalculateEstimatePrice(this)" class="form-control text-end" name="market_price" id="market_price" value="{{number_format($vehicleDetails->market_price, 2, '.', ',')}}" placeholder="" >
                                    <div class="hasErr"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" onchange="forceCurrency(this);autoCalculateEstimatePrice(this)" class="form-control text-end" placeholder="" name="estimate_repair" value="{{number_format($vehicleDetails->estimate_repair, 2, '.', ',')}}" id="estimate_repair" placeholder="" >
                                    <div class="hasErr"></div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-2">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onchange="tempohBerekonomi()" name="durabilty" id="durabilty" placeholder="" value="{{$vehicleDetails->durabilty}}" >
                                    <div class="hasErr"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="txt-data ass_gov mt-2"><small>RM</small> {{$vehicleDetails->vehicle_price}}</div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-2 col-md-3 col-sm-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="txt-data ass_gov mt-2">{{$vehicleDetails->hasAssessmentDetail->hasBpkNo->code}}</div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-end" name="odo_read" id="odo_read" value="{{$AssessmentCheckListDetail->odo_read}}" placeholder="" onchange="this.value = this.value.toUpperCase()" onchange="summarizeThisForm()" style="max-width: 140px">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="btn-group" id="wheel_type">
                                        ...
                                        <span data-drive="6X4" class="btn cux-btn bigger {{$AssessmentCheckListDetail->wheel_type == "6X4" ? 'active' : ''}}">6X4</span> --}}
                                    </div>
                ...
                <div class="row thin-topline" id="KAEDAH">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 pt-2">
                        <div class="row pb-2">
                            ...
                            <div class="col-md-6" id="reload_vtl" style="display: {{$AssessmentCheckListDetail->evaluation_type == 'Manual' ? 'none' : 'block'}}" >
                                <div class="form-group">
                                        ...
                                        <label class="btn cux-btn bigger mb-3" for="vtl_report"><i class="fas fa-image"></i> {{$AssessmentCheckListDetail->vtl_report ? 'Tukar Fail' : 'VTL'}} </label>
                                            ...
                                            @php
                                                ...
                                                if($AssessmentCheckListDetail->vtl_report){
                                                    $pathUrl =  '/storage/app/public/gov_loan/vtl_report/'.$AssessmentCheckListDetail->vtl_report ? '' : null;
                                                }
                                            @endphp
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="bottom_part_cond" class="form-control" id="bottom_part_cond" rows="3" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->bottom_part_cond}}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="" class="form-label text-dark">Bahagian Dalam</label>
                                    <textarea name="inner_part_cond" class="form-control" id="inner_part_cond" rows="3" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->inner_part_cond}}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="" class="form-label text-dark">Bahagian Luar</label>
                                    <textarea name="outer_part_cond" class="form-control" id="outer_part_cond" rows="3" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->outer_part_cond}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 pt-3">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-10">
                                <div class="form-group">
                                    <textarea name="engine_system" class="form-control" id="engine_system" rows="2" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->engine_system}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <textarea name="trans_system" class="form-control" id="trans_system" rows="2" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->trans_system}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <textarea name="susp_system" class="form-control" id="susp_system" rows="2" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->susp_system}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <textarea name="brek_system" class="form-control" id="brek_system" rows="2" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->brek_system}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <textarea name="wiring_system" class="form-control" id="wiring_system" rows="2" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->wiring_system}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <textarea name="aircond_system" class="form-control" id="aircond_system" rows="2" onchange="this.value = this.value.toUpperCase()">{{$AssessmentCheckListDetail->aircond_system}}</textarea>
                                </div>
...
<div class="modal fade modal-asking" id="prompApprovalModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="verifyApplicationModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        submitExaminationAchievementVehicle = function(formData, save_as){
            ...
            parent.startLoading();
            $.ajax({
                url: "{{ route('assessment.gov_loan.vehicle-assessment.form.save') }}",
                type: 'post',
                data: formData,
                cache: false,
                contentType: false,
        ...
        uploadFileReceipt = function(self){
            ...
            $.ajax({
                url: "{{ route('assessment.gov_loan.vehicle-assessment.form-file.save') }}",
                type: 'post',
                data: formData,
                cache: false,
                contentType: false,
        ...
        deleteRelatedDoc = function(vehicle_id, section, image_id){
            $.post("{{route('assessment.gov_loan.deleteRelatedDoc')}}", {
