...
$vehicleDetails = AssessmentGovLoanVehicle::where('assessment_gov_loan_id', $assessment_id)
...
<form class="row" id="frm_approval" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-12" id="assessment_gov_loan_vehicle_evaluation">
            ...
            <div class="row">
                <div class="col-md-12 mt-2 mb-2">
                    <div class="form-group center">
                        {{-- <span class="btn btn-module" onclick="prompAssessmentGovLoanEvaluateModal()">Hantar</span> --}}
...
<!--<div class="modal fade" id="assessmentGovLoanEvaluationModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="assessmentGovLoanEvaluationModalLabel" aria-hidden="true">
...
<div class="modal fade modal-asking" id="assessmentGovLoanEvaluationModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="assessmentGovLoanEvaluationModalLabel" aria-hidden="true">
    <div class="modal-dialog">
...
<script type="text/javascript">
    ...
    prompAssessmentGovLoanEvaluateModal = function(){
        $('#assessmentGovLoanEvaluationModal').modal('show');
    }

    loadAssessmentGovLoanVehicleEvaluation = function() {
        $.get("{{ route('assessment.gov_loan.vehicle-evaluation.list') }}", function(result){
            $('#assessment_gov_loan_vehicle_evaluation').html(result);
        });
    }
    ...
    assessmentVehicleEvaluate = function(self){
        ...
        $.post('{{route('assessment.gov_loan.approval')}}', {
            '_token': '{{ csrf_token() }}'
        }, function(response){
    ...
    saveReceipt = function(self){
        ...
        $.post('{{route('assessment.gov_loan.vehicle-evaluation.save-receipt')}}', {
            '_token': crf,
            'id': id,
    ...
    $(document).ready(function(){
        loadAssessmentGovLoanVehicleEvaluation();
    })
