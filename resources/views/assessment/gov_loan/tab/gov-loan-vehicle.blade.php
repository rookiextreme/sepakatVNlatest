...
<form class="row" id="frm_vehicle" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-12 mb-4" id="assessment_gov_loan_vehicle">
        </div>
    </div>
    <hr/>
      ...
      <div class="modal-content">
        ...
        <form id="frmAssignAssessmentVehicleAppointment" action="">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" onclick="loadAssessmentGovLoanVehicle()" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            </div>
        </form>
      </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="small-title">Maklumat Kenderaan
                    <div>Maklumat kenderaan terpakai yang hendak dibeli</div>
                </div>
                <span>
                    ...
                    <div class="row">
                        {{-- <div class="col-xl-2 col-lg-3 col-md-3" style="position: relative">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-end" name="market_price" id="market_price" placeholder="" onchange="forceCurrency(this)">
                                <div class="hasErr"></div>
                            </div>
                        </div> --}}
                        <div class="col-xl-2 col-lg-3 col-md-3" style="position: relative">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-end" name="original_price" id="original_price" placeholder="" onchange="forceCurrency(this)">
                                <div class="hasErr"></div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    loadAssessmentGovLoanVehicle = function() {
        let data = {
            'page': currentPage,
        }
        $.get("{{ route('assessment.gov_loan.vehicle.list') }}", data, function(result){
            $('#assessment_gov_loan_vehicle').html(result);
            let totalVehicle = $('#assessment_gov_loan_vehicle tbody tr.vehicle').length;
    ...
    submitAssessmentGovLoanVehicle = function(data) {

        $('.hasErr').html('');

        $.ajax({
            url: "{{ route('assessment.gov_loan.vehicle.save') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
    ...
    init_func_vehicle_edit = function(){
        ...
        $('#frmEditAssessmentVehicle').on('submit', function(e) {
            ...
            submitEditAssessmentGovLoanVehicle(formData);
    ...
    //     $.ajax({
    //         url: "{{ route('assessment.gov_loan.vehicle.checkExistRegNumber') }}",
    //         type: 'post',
    //         data: {
            ...
            success: function(res) {
                ...
                if(hasData){
                    ...
                    if(hasData.original_price){
                        console.log("price", hasData.original_price);
    ...
    $(document).ready(function(){
        ...
        $('#frmAddAssessmentVehicle').on('submit', function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            formData.append('assessment_govloan_id', {{$id}});
            submitAssessmentGovLoanVehicle(formData);
