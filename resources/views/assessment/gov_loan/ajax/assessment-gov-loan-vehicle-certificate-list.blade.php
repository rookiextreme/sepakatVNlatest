                    ...
                    <td class="text-center">
                        @if($vehicle->hasAssessmentVehicleStatus->code == '06')
                            <div class="btn-group">
                                ...
                                href="{{route('jasperReport', ['format' => 'pdf', 'title' => 'Sijil Harga Semasa', 'report_name' => 'assessment_certificate_gov_loan', 'table_name'=>'assessment_gov_loan', 'vehicle_id' => $vehicle->id])}}"
                                >
