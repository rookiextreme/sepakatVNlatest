...
<div class="table-responsive">
    <table class="table-custom no-footer stripe">
        <thead>
            @if($hasAssessmentGovLoanDetail->hasStatus->code == '01')
                {{-- <th class="col-del">
            ...
            <th>Buatan</th>
            <th>Model</th>
            @if($hasAssessmentGovLoanDetail->hasStatus->code == '08')
            <th>Senarai Semak</th>
            @endif
        </thead>
        <tbody>
                ...
                <tr class="vehicle">
                    ...
                    <td class="caps">
                        ...
                        @if($OwnImage > 0)
                            <button type="button" class="btn cux-btn small" data-bs-toggle="modal" data-bs-target="#vehicleImagesModal"
                                onclick="loadVehicleImages({{$vehicle->id}}, '05')"><i class="fa fa-image-polaroid"></i> </button>
                    ...
                    <td>
                        <a
                            ...
                            href="{{route('jasperReport', ['format' => 'pdf', 'title' => 'Senarai Semak', 'report_name' => 'assessment_gov_loan_checklist', 'vehicle_id' => $vehicle->id])}}"
                            >
...
{{$vehicleList->links('pagination.ajax-default', [
   'targetDivList' =>  '#assessment_gov_loan_vehicle',
   'params' => $params
])}}
