...
$govLoanAssessmentDAO = new AssessmentGovLoanDAO();
...
$totalCompleted = 0;
$totalRejected = 0;
$myjob_total = $govLoanAssessmentDAO->list($currentReq->merge(
    [
        'status_code' => 'my_job',
        'mode' => 'count'
    ]));
            ...
            <div class="col-xl-6 col-lg-8 col-md-8 col-sm-6 col-12">
                <div class="dropdown inline" style="display: inline;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item {{$status_code == 'my_job' ? 'active':''}}" onclick="parent.openPgInFrame('{{route('assessment.gov_loan.list', ['status_code' =>  'my_job'])}}')">Tindakan Saya
                    ...
                    @endphp
                     <tr>
                        ...
                        <td class="col-edit">
                            ...
                            <br>
                            <div class="btn-group">
                                    <button class='btn cux-btn' onclick="parent.openPgInFrame('{{route('assessment.gov_loan.register', [ 'id' =>  $gov_loan->id, 'tab' => $tab, 'status_code' => $status_code ])}}')"><i class="fa fa-pencil-alt"></i></button>
                        ...
                        <td><a href="{{route('assessment.gov_loan.register', [ 'id' =>  $gov_loan->id, 'tab' => $tab, 'status_code' => $status_code ])}}">{{$gov_loan->ref_number}}</a></td>
                        <td><a href="{{route('assessment.gov_loan.register', [ 'id' =>  $gov_loan->id, 'tab' => $tab, 'status_code' => $status_code ])}}">{{$gov_loan->applicant_name}}</a></td>
