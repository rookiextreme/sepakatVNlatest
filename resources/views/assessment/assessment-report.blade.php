...
<body class="content">
    ...
    <div class="row content-row header">
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 hailait stt" style="position: relative;">
            ...
            <div class="rpt-title">Ringkasan</div>
        </div>
    ...
    <div class="row content-row">
        <div class="col-xl-3 col-lg-3 col-Umd-3 col-sm-3 col-12 hailait">
            <ul class="menu">
                <li>Ringkasan</li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_mth')}}">Seluruh CKM</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('assessment.report.branch.year')}}">Ringkasan Tahunan Mengikut CKMN</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('assessment.report.agency.month')}}">Ringkasan Bulanan Mengikut Kementerian</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('assessment.report.branch.month')}}">Ringkasan Bulanan Mengikut CKMN</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('assessment.report.vtl_cwgn')}}">VTL CWGN</a></li>{{-- SEMUA CAWANGAN --}}
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('assessment.report.vtl_ckmn')}}">VTL CKMN</a></li>{{-- CAWANGAN KEJURUTERAAN MEKANIKAL --}}
            </ul>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
            <ul class="menu">
                <li>Penilaian</li>
                <li><i class="fal fa-chart-line"></i> <a href="{{ route('report.report_appl_by_mth')}}">Mengikut Woksyop</a></li>
                <li><i class="fal fa-chart-line"></i> <a href="{{ route('report.report_trend_analysis')}}">Tren Sepanjang Tahun</a></li>
            </ul>
            {{-- <ul class="menu">
        ...
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 hailait">
            <ul class="menu">
                <li>Penilaian mengikut Woksyop</li>
                <li><i class="fal fa-map-marked-alt"></i> <a href="{{ route('report.report_assessment_map')}}">Mengikut Woksyop</a></li>
            </ul>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
            <ul class="menu">
                <li>Senarai Penilaian</li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_wsp')}}?workshop_id=1&assessment_type=new">Kenderaan Baharu</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_wsp')}}?workshop_id=1&assessment_type=safety">Keselamatan & Prestasi</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_wsp')}}?workshop_id=1&assessment_type=currvalue">Harga Semasa</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_wsp')}}?workshop_id=1&assessment_type=accident">Kemalangan</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_wsp')}}?workshop_id=1&assessment_type=gov">Pinjaman Kerajaan</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('report.report_appl_by_wsp')}}?workshop_id=1&assessment_type=disposal">Pelupusan</a></li>
                <li><i class="fal fa-chart-pie"></i> <a href="{{ route('assessment.report.overall')}}">Senarai Pemeriksaan</a></li>
            </ul>
        </div>
    </div>
<script>
