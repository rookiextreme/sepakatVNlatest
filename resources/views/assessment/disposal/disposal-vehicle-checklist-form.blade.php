        ...
        <div class="row" id="assess-form">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 paper mt-4" style="{{auth()->user()->isAssistEngineerAssessment() || auth()->user()->isEngineerAssessment() ? '' : 'display: none'}}">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 bac_wf p-0">
                        <div class="row">
                            <div class="col-xl-3 col-lg-2 col-md-2 col-sm-2 col-5 text-end small-section" onclick="calculateDepreciationValue();">Penolong Jurutera</div>
                            <div class="col-xl-9 col-lg-10 col-md-10 col-sm-10 col-7 wf-details" id="test">{{auth()->user()->isAssistEngineerAssessment() ? auth()->user()->name : ''}}</div>
                        </div>
                        <div class="row">
                            <div class="col-xl-3 col-lg-2 col-md-2 col-sm-2 col-5 text-end small-section">Tarikh & Masa</div>
                            <div class="col-xl-9 col-lg-10 col-md-10 col-sm-10 col-7 wf-details">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-3 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="txt-data" id="harga-asal"><small>RM</small> {{ $AssessmentDisposalVehicle->original_price == 'NaN' || $AssessmentDisposalVehicle->original_price == null ? 0.00 :
                                    number_format($AssessmentDisposalVehicle->original_price, 2, '.', ',')   }}</div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-3 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn cux-btn bigger" style="margin-top:-7px" id="suggestion"><a href="javascript:openFromMenu('{{ route('assessment.depreciation') }}')" style="text-decoration:none; color:#1e1d1f"></i> Kalkulator</a></button>
                                    </div>
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-3 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="txt-data" id="harga-nilai-semasa"><p style="font-size: 40px;" id="current_value2">{{$AssessmentDisposalVehicle->current_value == null ? 0: number_format($AssessmentDisposalVehicle->current_value, 2, '.', ',')}}</p></div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-3 col-6">
                                <div class="form-group">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 paper mt-4">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 bac_wf p-0">
                        <div class="row">
                            <div class="col-xl-3 col-lg-2 col-md-2 col-sm-2 col-5 text-end small-section">Pembantu Kemahiran</div>
                            <div class="col-xl-9 col-lg-10 col-md-10 col-sm-10 col-7 wf-details">{{$AssessmentDisposalVehicle->foremenBy ? $AssessmentDisposalVehicle->foremenBy->name : '-'}}</div>
                        </div>
                        <div class="row">
                            <div class="col-xl-3 col-lg-2 col-md-2 col-sm-2 col-5 text-end small-section">Tarikh & Masa</div>
                            <div class="col-xl-9 col-lg-10 col-md-10 col-sm-10 col-7 wf-details">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding-top:3px;padding-left:4px;padding-right:4px;padding-bottom:0px;">
                                            <textarea name="form_note_lvl1_component_id_{{$AssessmentFormCheckLvl1->id}}" id="form_note_lvl1_component_id_{{$AssessmentFormCheckLvl1->id}}" rows="1" class="form-control mustcheck" maxlength="200" onchange="summarizeThisForm()">{{$AssessmentFormCheckLvl1->note}}</textarea>
