        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-sm-4 col-6">
                ...
                @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01','02']) || auth()->user()->isAdmin())
                    ...
                    value="{{$detail ? $detail->ic_no : auth()->user()->identity_no}}"
    ...
    <fieldset class="mt-4">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                <div class="txt-data ass_dis thin-underline" style="height:52px">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                <div class="row">
                    @if(!$detail ||$is_myApp && in_array($detail->hasStatus->code, ['01']) || auth()->user()->isAdmin())
                        <div class="input-group date form_datetime" id="date1Container" data-date="{{$detail && $detail->appointment_dt1 ? $detail->appointment_dt1 : ''}}" data-date-format="dd MM yyyy - HH:ii p" data-link-field="date_1">
                            <input class="form-control" size="16" id="date_1_input" type="text"
                            value="{{$detail && $detail->appointment_dt1 ? Carbon\Carbon::parse($detail->appointment_dt1 )->format('d-M-Y g:i A') : ''}}"
                        ...
                        <input type="hidden" name="date_1"  value="{{$detail && $detail->appointment_dt1 ? Carbon\Carbon::parse($detail->appointment_dt1 )->format('d-M-Y g:i A') : ''}}" />
                    ...
                    <input type="hidden" name="date_2"  value="{{$detail && $detail->appointment_dt2 ? Carbon\Carbon::parse($detail->appointment_dt2 )->format('d-M-Y g:i A') : ''}}" />
                    {{-- <div class="col-xl-5 ps-0">
                    ...
                    <input type="hidden" name="date_3"  value="{{$detail && $detail->appointment_dt3 ? Carbon\Carbon::parse($detail->appointment_dt3 )->format('d-M-Y g:i A') : ''}}" />
                    {{-- <div class="col-xl-5 ps-0">
...
<script type="text/javascript">
    ...
    function submitApplication(data) {
        ...
        var date =  $('#appointment_date_1').val();
        console.log(date);
    ...
    $(document).ready(function(){
        ...
        //     if(dtime != ''){
        //         both = convertDateToDB(ddate) + " " + convertTimeToDB(dtime);
        //     }else{
