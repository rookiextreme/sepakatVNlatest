...
@endphp
<script>
    function currencyLocal(data){
        var thisval = data.replace(/[^\d.]+/g,'');
        ...
        <div class="row">
            <div class="col-md-12 pt-2">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn cux-btn bigger" xaction="delete_all" data-bs-toggle="modal" data-bs-target="#assessmentDisposalVehicleDelModal" id="delete_all" disabled type="button" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Some info"><i class="fal fa-trash-alt"></i> Hapus</button>

                </div>
                @endif
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 mb-2" id="assessment_disposal_vehicle"></div>
        </div>
    </fieldset>
    <hr/>
      ...
      <div class="modal-content">
        ...
        <form id="frmAssignAssessmentVehicleAppointment" action="">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" onclick="loadAssessmentDisposalVehicle()" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            </div>
        </form>
      </div>
    </div>
...
<div class="modal fade" id="addAssessmentVehicleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="" aria-labelledby="addAssessmentVehicleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <div class="small-title">Maklumat Aset
                    <div>Kenderaan atau jentera yang hendak dilupuskan</div>
                </div>
                <span>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <p>
                        <i class="fas fa-info"> </i>  Maklumat yang diberikan haruslah betul dan ruangan bertanda <span class="text-danger">*</span> hendaklah diisi. Jika tiada maklumat, isi <i>TIDAK BERKENAAN</i>.
                    </p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-3" style="position: relative">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="plate_no" id="plate_no" placeholder="VBA112" xplate_no onchange="forceCaps(this)" maxlength="20">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="engine_no" id="engine_no" placeholder="4D56-EL0995" xengine_no onchange="this.value = this.value.toUpperCase()" onblur="stopAnimate()">
                            <div class="hasErr"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="chasis_no" id="chasis_no" placeholder="52WVC10338" xchasis_no onchange="this.value = this.value.toUpperCase()">
                            <div class="hasErr"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="model_name" id="model_name" placeholder="SAGA" xmodel_name onchange="this.value = this.value.toUpperCase()">
                            <div class="hasErr"></div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="manufactureYear" data-date="" data-date-format="yyyy" data-link-field="manufacture_year">
                                <input class="form-control" size="16" id="manufactureYearInput" xmanufacture_year type="text" value="" placeholder="TAHUN" readonly>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="registrationVehicleDt" data-date="" data-date-format="dd/mm/yyyy" data-link-field="registration_vehicle_dt">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12" xfunction="sub_category_type_id" id="display_list_sub_category_type" style="display:none;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">No. Siri<br/>Pendaftaran Aset <i class="fa fa-info-circle spakat-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Sila rujuk Borang KEW.PA-2/PA-3" id="tip-kewpa"></i><span class="text-danger">*</span></label>
                                <input onchange="this.value = this.value.toUpperCase()" type="text" class="form-control" name="aset_regno" id="aset_regno" placeholder="" xcompany_name>
                                <div class="hasErr"></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">No. Kodifikasi<br/>Nasional <i class="fa fa-info-circle spakat-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Sekiranya aset berdaftar dengan Sistem Kodifikasi Nasional"></i> <span class="text-danger"></span></label>
                                <input onchange="this.value = this.value.toUpperCase()" type="text" class="form-control" name="nc_no" id="nc_no" placeholder="" xcompany_name>
                                <div class="hasErr"></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-2 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">Harga<br/>Perolehan Asal <small>RM</small><span class="text-danger">*</span></label>
                                <input onchange="forceCurrency(this)" type="text" class="form-control currency" name="original_price" id="original_price" placeholder="" xcompany_name>
                                <div class="hasErr"></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="form-group">
                                <label for="" class="form-label">Tarikh<br/>Pembelian <span class="text-danger">*</span> </label>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">Jumlah Kos Penyelenggaraan<br/>Terdahulu <small>RM</small><span class="text-danger">*</span></label>
                                <input onchange="forceCurrency(this)" style="max-width:130px" type="text" name="earlier_maintenance_cost" id="earlier_maintenance_cost" class="form-control text-end">
                                <div class="hasErr"></div>
                            </div>
                        </div>
            ...
            <div class="modal-footer justify-content-start">
                <button type="submit" class="btn btn-module float-start add_vehicle"><i class="fal fa-plus"></i> &nbsp;Tambah</button>
                <button type="submit" class="btn btn-module float-start edit_vehicle" style="display:none;"><i class="fal fa-save"></i> &nbsp;Simpan</button>
...
<div class="modal fade" id="viewVehicleInformation" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="" aria-labelledby="viewVehicleInformationLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="frmEditAssessmentVehicle" action="">
            @csrf
            <div class="modal-body" style="width:97%">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" >
                            <div class="row">
                                ...
                                {{-- <div class="col-md-12" id="diff_sub_category_type" style="display: none">
                                    <div class="form-group">
                                        <label for="" class="form-label text-dark">Lain-Lain Jenis Kenderaan</label>
                                        <div class="txt-data ass_dis"><span id="diff_sub_category_type_name" class="txt-data ass_dis"></span></div>
                                    </div>
                                </div> --}}
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">No. Siri<br/>Pendaftaran Aset  </label>
                                <div class="txt-data ass_dis"><span id="no_siri_pend" class="txt-data ass_dis"></span></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">No. Kodifikasi<br/>Nasional  </label>
                                <div class="txt-data ass_dis"><span id="no_lod_na" class="txt-data ass_dis"></span></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-2 col-md-4">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">Harga<br/>Perolehan Asal</label>
                                <div class="txt-data ass_dis"><span id="perolehan_asal" class="txt-data ass_dis"></span></div>
                                <div class="hasErr"></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="form-group">
                                <label for="" class="form-label">Tarikh<br/>Pembelian </label>
                                <div class="txt-data ass_dis"><span id="tarikh_pembelian" class="txt-data ass_dis"></span></div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="form-group">
                                <label for="" class="form-label text-dark">Jumlah Kos Penyelenggaraan<br/>Terdahulu <small>RM</small><span class="text-danger">*</span></label>
                                {{-- <div class="txt-data ass_dis"><span id="kos_terdahulu" class="txt-data ass_dis"></span></div> --}}
                                <input onchange="forceCurrency(this)" style="max-width:130px" type="text" name="earlier_maintenance_cost" id="earlier_maintenance_cost" class="form-control text-end">
                                <div class="hasErr"></div>
                            </div>
                        </div>
            ...
            @if (!$detail->app_status_id == 9)
            <div class="modal-footer flex justify-content-start">
                <button type="submit" class="btn btn-module float-start edit_cost"><i class="fal fa-save"></i> Kemaskini </button>
...
<script type="text/javascript">
    ...
    function getSubCategoryType(sub_category_id){
        ...
        $.get("{{route('vehicle.ajax.getSubCategoryType')}}", {
            ...
            // let list_sub_category = $('#list_sub_category');
            // let other = list_sub_category.find('option:selected', this).data('code');
            ...
            if (count == 0){
                ...
                //     console.log('masuk sini 2');
                    // $('#list_sub_category_type').append('<option value="" data-code="00" data-name="" >LAIN-LAIN</option>');
                // }
            }
            if(count == totalInit){
                if(!same){
    ...
    loadAssessmentDisposalVehicle = function() {
        let data = {
            'page': currentPage,
        }
        $.get("{{ route('assessment.disposal.vehicle.list') }}", data, function(result){
            $('#assessment_disposal_vehicle').html(result);
            let totalVehicle = $('#assessment_disposal_vehicle tbody tr.vehicle').length;
    ...
    submitAssessmentNewVehicle = function(data) {
        ...
        $.ajax({
            url: "{{ route('assessment.disposal.vehicle.save') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
    ...
    submitEditAssessmentNewVehicle = function(data) {

    $('.hasErr').html('');
    parent.startLoading();
    $.ajax({
        url: "{{ route('assessment.disposal.vehicle.update') }}",
        type: 'post',
        data: data,
        cache: false,
        contentType: false,
        ...
        success: function(response) {
            ...
            console.log("here");
            $('#frm_vehicle #response').html('<span class="text-success">'+response.message+'</span>').fadeIn(500).fadeOut(5000);
            $('#viewVehicleInformation').modal('hide');
            // viewVehicle();
            loadAssessmentDisposalVehicle();
            if(response.total_vehicle > 0){
                $('#frm_vehicle .verify').prop('disabled', false);
    ...
    selectAssessmentDisposalVehicle = function(id){
        $('#assignAssessmentVehicleAppointment').find('#detail_id').val(id);
    }
    assignVehicleAppointment = function(data){
        $.ajax({
            url: "{{ route('assessment.disposal.vehicle.assignAppointment') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
    ...
    function checkExistRegNumber(plate_no){
        ...
        $('.hasErr').html('');
        $.ajax({
            url: "{{ route('assessment.disposal.vehicle.checkExistRegNumber') }}",
            type: 'post',
            data: {
                plate_no: plate_no,
                assessment_type: 'disposal',
                '_token': '{{ csrf_token() }}',
            },
            dataType: 'json',
            success: function(res) {
                ...
                if(hasData){
                    if(hasData.engine_no){
                        $('#engine_no').val(hasData.engine_no);
                    }
                    else{
                        $('#engine_no').val('');
                    }
                    if(hasData.chasis_no){
                        $('#chasis_no').val(hasData.chasis_no);
                    }
                    else{
                        $('#chasis_no').val('');
                    }
                    $('#brand').val(hasData.vehicle_brand_id).trigger("change");
                    if(hasData.chasis_no){
                        $('#model_name').val(hasData.model_name);
                    }
                    else{
                        $('#model_name').val('');
                    }
                    if(hasData.manufacture_year){
                        $('[xmanufacture_year]').val(moment(hasData.manufacture_year, 'YYYY').format('YYYY'));
                    }
                    else{
                        $('[xmanufacture_year]').val('');
                    }
                    if(hasData.registration_vehicle_dt){
                        $('#registrationVehicleDtInput').val(moment(moment(hasData.registration_vehicle_dt, 'YYYY-MM-DD')).format('DD/MM/YYYY'));
                        $('#registration_vehicle_dt').val(moment(hasData.registration_vehicle_dt).format('YYYY-MM-DD HH:mm'));
                    }
                    else{
                        $('#registrationVehicleDtInput').val('');
                        $('#registration_vehicle_dt').val('');
                    }
                    let is_move = hasData.is_move;
                    if (is_move == true){
                        $('#cannot_move').prop("checked", false);
                        $('#can_move').prop("checked", true);
                    }
                    else{
                        console.log("ada data tak bergerak", hasData.is_move);
                        $('#cannot_move').prop("checked", true);
                        $('#can_move').prop("checked", false);
                    }
                    if(hasData.location){
                        $('#location').val(hasData.location);
                    }
                    else{
                        $('#location').val('');
                    }
                    if(hasData.aset_regno){
                        $('#aset_regno').val(hasData.aset_regno);
                    }
                    else{
                        $('#aset_regno').val('');
                    }
                    if(hasData.aset_regno){
                        $('#nc_no').val(hasData.nc_no);
                    }
                    else{
                        $('#nc_no').val('');
                    }
                    var original_price = hasData.original_price;
                    if(hasData.original_price){
                        $('#original_price').val(currencyLocal(original_price));
                    }
                    else{
                        $('#original_price').val('');
                    }
                    if(hasData.purchase_dt){
                        $('#purchaseDtInput').val(moment(moment(hasData.purchase_dt, 'YYYY-MM-DD')).format('DD/MM/YYYY'));
                        $('#purchase_dt').val(moment(hasData.purchase_dt).format('YYYY-MM-DD HH:mm'));
                    }
                    else{
                        $('#purchaseDtInput').val('');
                        $('#purchase_dt').val('');
                    }
                    var earlier_maintenance_cost = hasData.earlier_maintenance_cost;
                    if(hasData.earlier_maintenance_cost){
                        $('#earlier_maintenance_cost').val(currencyLocal(earlier_maintenance_cost));
                    }
                    else{
                        $('#earlier_maintenance_cost').val('');
                    }
                    categoryId = hasData.category_id;
                    subCategoryId = hasData.sub_category_id;
                    subCategoryTypeId = hasData.sub_category_type_id;
                    $('#category').val(hasData.category_id).trigger("change");
            ...
            //         let key = 'plate_no';
            //         if($('[name="'+key+'"]').parent().find('.hasErr .text-danger').length == 0){
            //             $('[name="'+key+'"]').parent().find('.hasErr').append('<div class="text-success col-12 fs-6">No Pendaftaran '+plate_no+' Telah Wujud</div>');
            //             addBtn.prop('disabled', true);
            //             // stopAnimate();
            //         }
            //     } else {
    ...
    editAssessmentVehicle = function(vehicle_id, functional, self){
        ...
        $.ajax({
            url: '{{Route("assessment.disposal.vehicle.getVehicleForm")}}',
            type: 'get',
            data: {
            ...
            dataType: 'json',
                success: function(data) {
                    ...
                    $('#aset_regno').val(data.aset_regno);
                    $('#nc_no').val(data.nc_no);

                    var original_price = data.original_price;
                    $('#original_price').val(currencyLocal(original_price));
                    var earlier_maintenance_cost = data.earlier_maintenance_cost;
                    $('#earlier_maintenance_cost').val(currencyLocal(earlier_maintenance_cost));
        ...
        viewVehicle = function(vehicle_id, functional){
            ...
            dataType: 'json',
                success: function(data){
                    viewVehicleInformation.find('#assessment_vehicle_id').val(data.id);
                    ...
                    viewVehicleInformation.find('#no_siri_pend').html(data.aset_regno);
                    viewVehicleInformation.find('#no_lod_na').html(data.nc_no);
                    viewVehicleInformation.find('#perolehan_asal').html("RM "+data.original_price);
                    viewVehicleInformation.find('#kos_terdahulu').html("RM "+data.earlier_maintenance_cost);
                    viewVehicleInformation.find('#earlier_maintenance_cost').val(currencyLocal(data.earlier_maintenance_cost));
    ...
    function loadVehicleImages(id, code){ /////
        let vehicle_id = id;
        let assessment_code = code;
        // console.log('load their image', vehicle_id, assessment_code);
        $.get("{{route('assessment.ajax.getModalVehicleImages')}}", {
    ...
    $(document).ready(function(){
        ...
        //$('#original_price').val(forceCurrency($('#original_price').val()));
        ...
        $('#frmAddAssessmentVehicle').on('submit', function(e) {
            ...
            let formData = new FormData(this);
            formData.append('assessment_disposal_id', {{$id}});
