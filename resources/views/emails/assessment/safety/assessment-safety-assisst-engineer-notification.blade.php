@php
    ...
    $AssessmentSafetyVehicle = AssessmentSafetyVehicle::where('assessment_safety_id',$details['assessment_id'])->get();
@endphp
<!DOCTYPE html>
<html>
...
<body>
    ...
    Tarikh dan masa temujanji adalah, {{Carbon\Carbon::parse($details['appointment_dt'] )->format('d M Y g:i A')}}. Segala pertanyaan berkaitan permohonan boleh diajukan kepada  {{$details['worksyop']}}</div>
    <br/><br/>
