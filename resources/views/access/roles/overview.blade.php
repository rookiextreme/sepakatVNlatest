...
<div class="main-content">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-6" style="position: relative">
                <div class="spectitle" style="position: absolute;left:0px;top:-50px;width:400px">Pengurusan Akses</div>
                <div class="round-point" onclick="openPgInFrame('{{route('access.user.approval')}}')">
                    ...
                    <div class="pointer d-sm-none d-lg-block text-center"><i class="fal fa-chevron-right fa-lg"></i></div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-6">
                <div class="round-point" onclick="openPgInFrame('{{route('access.user.registered')}}')">
            ...
            <div class="col-lg-4 col-sm-12 mt-lg-0 mt-md-3 mt-sm-3 col-12">
                <div class="round-point special">
                <a href="javascript:openPgInFrame('{{ route('access.audit_list') }}')">
