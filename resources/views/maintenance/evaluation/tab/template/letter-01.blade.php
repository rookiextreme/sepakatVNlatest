    ...
    <table class="table table-borderless" id="letter{{$template_type_code}}" style="width: 100%">
                ...
                <table class="float-start" style="width:{{$is_preview ? '400px': '100%';}}">
                    <tr>
                        <td>
                            ...
                            <textarea onchange="saveElement(this)" style="width: 400px; resize: none;" name="address_to" id="" cols="30" rows="7" class="form-control" placeholder="Butiran Penerima Surat">{{$detail->address_to}}</textarea>
                            @endif
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td colspan="3" class="" style="line-height: 21px">
                ...
                pada <label>
                    ...
                    @else
                        <div class="input-group date form_datetime" id="appointmentDtContainer" data-date-format="dd MM yyyy" data-link-field="appointment_dt">
                            ...
                            <label class="input-group-text" for="appointmentDt_input">
                ...
                </label> dan mencadangkan kerja-kerja pembaikan berikut:
            </td>
        </tr>
            ...
            <tr>
                <td colspan="3" class="">
                    ...
                    <div class="form-group">
                        <span class="btn cux-btn small" onclick="addCheckList()"> <i class="fa fa-plus"></i> Tambah</span>
                    </div>
                    @endif
        ...
        <tr>
            <td colspan="3" class="" style="line-height: 21px">
                ...
                upah pemasangan adalah lebih kurang RM <label class="text-dark" id="total_budget">{{number_format($totalBudget,2)}}</label> ( Ringgit Malaysia : <label class="text-dark" id="total_budget_with_word">{{ucwords($f->format($totalBudget))}}</label> Sahaja ).
            </td>
        </tr>

        <tr>
            <td colspan="3">
                4.	Anggaran ini adalah berdasarkan pemeriksaan fizikal sahaja. Sekiranya terdapat pertambahan kerja-kerja pembaikan,
                pihak tuan boleh merujuk semula kepada pihak kami untuk tujuan pengesahan semula.
            </td>
        </tr>
