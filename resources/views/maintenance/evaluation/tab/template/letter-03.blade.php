    ...
    <table class="table table-borderless" id="letter{{$template_type_code}}" style="width: 100%">
        ...
        <tr>
            <td colspan="3" class="" style="line-height: 21px">
                ...
                dan bersetuju dengan kerja-kerja yang dicadang oleh pihak bengkel (sebutharga :
                @if($is_preview)
                    {{$detail->body_detail}}
                @else
        ...
        <tr>
            <td colspan="3" class="" style="line-height: 21px">
                3. Bagaimanapun, pihak kami tidak mengeluarkan anggaran atau mengesahkan kos pembaikan bagi kerja-kerja tersebut.
            </td>
        </tr>
