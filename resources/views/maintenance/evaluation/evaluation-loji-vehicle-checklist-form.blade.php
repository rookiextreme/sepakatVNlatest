...
<body class="content">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pemeriksaan Kerosakan (Loji)</li>
        </ol>
    </nav>
    <div class="main-content">
        <form id="frm_examination_achievement_vehicle">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                        <h3>Pemeriksaan Dan Pengujian Loji/Jentera</h3>
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    <div class="col-md-12">
                        <div class="btn-group float-end">
                            ...
                            @endif
                            @if(auth()->user()->isForemenMaintenance())
                                <span xaction="verification" data-bs-toggle="modal" data-bs-target="#prompVerificationModal" class="btn cux-btn small">Hantar Semakan</span>
                                                        ...
                                                        @if($lvl1->hasManySelection->count()>0)
                                                            <div class="row">
                                                                @foreach ($lvl1->hasManySelection as $hasSelection)
                                                                    @php
                                                                        $tableList = DB::table($hasSelection->hasTableSelection->table)->where('status', 1)->get();
                                                                    @endphp
                                                ...
                                                @foreach ( $lvl1->hasFormComponentCheckListLvl2 as $lvl2 )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($lvl2->hasFormComponentCheckListLvl3->count()==0)
                                                                <div class="col-md-3">
                                                                    <label for="form_file_lvl2_component_id_{{$lvl2->id}}"
                                                                        class="btn cux-btn small form-label">Muat naik</label>
                                                                    <input
                                                                        onchange="uploadFile(this)" data-id="{{$lvl2->id}}" data-lvl="2"
                                                                        class="form-control d-none" accept="image/*"
                                                                        name="form_file_lvl2_component_id_{{$lvl2->id}}" type="file"
                                                                        id="form_file_lvl2_component_id_{{$lvl2->id}}" />
                                                                        @php
                                                                        $path = '';
                                                                        $pathThumb = '';
                                                                        $docName = '';
                                                    ...
                                                    @endforeach
                                                    <tr>
                                                        <td style="padding-left: 2em;"><label for="" class="form-label text-dark">Catatan</label></td>
                                                        <td style="padding-left: 2em;" colspan="2">
                                                            <div class="col-md-6">
                                                                <textarea style="resize: none;" class="form-control" name="form_note_lvl2_component_id_{{$lvl2->id}}" id="form_note_lvl2_component_id_{{$lvl2->id}}" cols="30"
                                                                    rows="5">{{$lvl2->note}}</textarea>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
