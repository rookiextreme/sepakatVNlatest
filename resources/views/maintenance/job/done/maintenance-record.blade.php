            ...
            <table id='perihal_kerja'  style='width:100%;border:none; margin-top:20px'>
                ...
                <tbody>
                    @if($hasForm)
                     @foreach ($hasForm->hasProcurementSelectedSupplierList as $component)
                        {{-- @php
                            $all_price = $component->hasFormComponent->quantity * $component->price;
                            $all_total_price = $all_total_price + $all_price;
                        @endphp --}}
                            <tr>
                                ...
                                <td style='color:black; text-align:center; border:1px solid black;font-size:12px;'>
                                    {{number_format($component->hasFormComponent->per_price, 2)}}
                ...
                <tfoot>
                    <tr>
                        ...
                        {{-- <td style="color: black; border:1px solid black; text-align:center;font-family:mark-bold;"> {{number_format($all_total_price, 2)}}</td> --}}
                        <td></td>
                    </tr>
                </tfoot>
            </table>
