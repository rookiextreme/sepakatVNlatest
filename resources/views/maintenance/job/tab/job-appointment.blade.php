...
<form class="row" id="frm_apppointment_vehicle" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>{{$detail && $detail->hasStatus->code == '01' ? 'Sila set':'' }} Maklumat Temujanji untuk servis dan pembaikan kenderaan</p>
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if($detail && $detail->hasStatus->code == '02' &&  ($detail->hasAssistantEngineerBy && $detail->hasAssistantEngineerBy->id == auth()->user()->id))
            ...
            @if( ($detail->hasAssistantEngineerBy && $detail->hasAssistantEngineerBy->id == auth()->user()->id))
                <div class="col-md-12" id="maintenance_job_vehicle_appointment">
        ...
        <div class="row">
            <div class="col-md-12 mt-2 mb-2">
                <div class="form-group center">
                    @if($detail->hasStatus->code == '02' &&  ($detail->hasAssistantEngineerBy && $detail->hasAssistantEngineerBy->id == auth()->user()->id))
...
const saveSilent = function(){
    ...
    const loadMaintenanceJobVehicleAppointment = function() {
        $.get("{{ route('maintenance.job.vehicle-appointment.list') }}", function(result){
            $('#maintenance_job_vehicle_appointment').html(result);
        });
    }

    const updateMaintenanceJobVehicleAppointment =  function(data){
        $.ajax({
            url: "{{ route('maintenance.job.register.save') }}",
            type: 'post',
            data: data,
            ...
            success: function(response) {
                ...
                // loadMaintenanceJobVehicleAppointment();
            },
    ...
    $(document).ready(function(){
        ...
        @if($detail &&  ($detail->hasAssistantEngineerBy && $detail->hasAssistantEngineerBy->id == auth()->user()->id))
        loadMaintenanceJobVehicleAppointment();
        @endif
        ...
        $('#frm_apppointment_vehicle').on('submit', function(e){
            ...
            updateMaintenanceJobVehicleAppointment(formData);
        });
