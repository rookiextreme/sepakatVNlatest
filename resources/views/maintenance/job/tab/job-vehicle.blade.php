...
<form class="row" id="frm_vehicle" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><i class="fas fa-info-circle"></i>  Sila masukkan maklumat kenderaan yang hendak dinilai.</p>
                            <div class="col-md-12">
                                <div class="btn-group" id="btn_group_crud">
                                    {{-- <a class="btn cux-btn bigger" aria-readonly="" data-bs-toggle="modal"data-bs-target="#submitMaintenanceJobVehicle"><i class="fal fa-plus"></i> Kenderaan</a> --}}
                                        <button type="button" class="btn cux-btn bigger" xaction="add_vehicle" onclick="addMaintenanceVehicle()"><i class="fal fa-plus"></i> Kenderaan</button>
                                    
                                    <button class="btn cux-btn bigger" xaction="delete_all" data-bs-toggle="modal" data-bs-target="#maintenanceJobVehicleDelModal" id="delete_all" disabled type="button" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Some info"><i class="fal fa-trash-alt"></i> Hapus</button>
                                </div>
                            </div>
                        @endif
                    </div>
            ...
            <div class="col-xl-10 col-lg-11 col-md-12 mb-4" id="maintenance_job_vehicle_list"></div>
        </div>
    </div>
    <hr/>
    <div class="form-group center">
        @if($is_myApp && in_array($detail->hasStatus->code, ['01']))
            <button disabled type="button" {{$detail->hasVehicle->count()>0 ? '':'disabled'}} class="btn btn-module verify" data-id="{{$detail ? $detail->id : null}}">Hantar</button>
        @endif
...
<div class="modal fade" id="maintenanceJobVehicleDelModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="maintenanceJobVehicleDelModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer float-start">
                ...
                <button type="button" id="remove" class="btn btn-danger text-white" onclick="remove()">Hapus</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="selectMaintenanceJobVehicle" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="" aria-labelledby="selectMaintenanceJobVehicleLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
          <div class="modal-header">
              <h5>Pilih Tarikh, Masa dan Woksyop</h5>
          </div>
        <form id="frmselectMaintenanceJobVehicle" action="">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" onclick="loadMaintenanceJobVehicle()" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            </div>
        </form>
      </div>
    </div>
...
<div class="modal fade" id="submitMaintenanceJobVehicle" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="" aria-labelledby="submitMaintenanceJobVehicleLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div>
                        ...
                        <div class="ms-2 mt-2" id="response" style="display: none;"></div>
                    </div>
                </div>
                <input type="hidden" name="maintenance_job_vehicle_id" id="maintenance_job_vehicle_id">
                <fieldset>
                    <legend>Tujuan Penyenggaran:</legend>
                    <div class="row">
                        <div class="col-md-6">
                            @foreach ($maintenance_job_purpose_type_list as $maintenance_job_purpose_type)
                                <input class="form-check-input mt-2 ms-2 form_check_purpose_type" type="checkbox" value="{{$maintenance_job_purpose_type->id}}" id="form_check_id_{{$maintenance_job_purpose_type->id}}">
                                <label class="form-check-label cursor-pointer" for="form_check_id_{{$maintenance_job_purpose_type->id}}">{{$maintenance_job_purpose_type->desc}}</label>
                            @endforeach
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="form-label">Aduan Kerosakan</label>
                                        <textarea onchange="forceCapsWithoutTrim(this)" name="complaint_damage" id="complaint_damage" class="form-control" style="resize: none;" maxlength="255" cols="30" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="form-label">Tarikh Akhir Servis</label>
                                        <div class="input-group date" id="last_service_dt"
                                            data-target-input="nearest">
                                                <input name="last_service_dt" id="last_service_dtInput"
                                                ...
                                                <div class="input-group-text" for="last_service_dtInput">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="plate_no" id="plate_no" placeholder="VBA112" xplate_no onchange="this.value = this.value.toUpperCase()">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <label for="" class="form-label text-dark">Lokasi Semasa Kenderaan <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <textarea style="resize: none;" class="form-control" name="current_loc" id="current_loc" onchange="this.value = this.value.toUpperCase()" cols="30" rows="3"></textarea>
                                    <div class="hasErr"></div>
                                </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="engine_no" id="engine_no" placeholder="4D56-EL0995" xengine_no onchange="this.value = this.value.toUpperCase()">
                            <div class="hasErr"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" name="vehicle_brand_id" id="brand" xbrand_name>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" name="fuel_type_id" id="fuel_type_id" xbrand_name>
                                <option value="">Sila Pilih</option>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-module float-start add_vehicle me-1">Tambah dan tutup</button>
...
<div class="modal fade" id="displayMaintenanceJobVehicleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="" aria-labelledby="displayMaintenanceJobVehicleModalLabel" aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="form-label">Aduan Kerosakan</label>
                                        <div id="complaint_damage"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="" class="form-label">Tarikh Akhir Servis</label>
                                        <div id="last_service_dt"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    const loadMaintenanceJobVehicle = function() {
        $.get("{{ route('maintenance.job.vehicle.list') }}", function(result){
            $('#maintenance_job_vehicle_list').html(result);
            let btnVerify = $('.verify');
            let totalVehicle = $('#maintenance_job_vehicle_list tbody tr[data-vehicle]').length;
            if(totalVehicle > 0){
                btnVerify.prop('disabled', false);
                $('[xaction="add_vehicle"]').remove();
            } else {
                btnVerify.prop('disabled', true);
                $('[xaction="delete_all"]').prop('disabled', true);
                if($('[xaction="add_vehicle"]').length == 0){
                    $('#btn_group_crud').prepend('<button type="button" class="btn cux-btn bigger" xaction="add_vehicle" onclick="addMaintenanceVehicle()"><i class="fal fa-plus"></i> Kenderaan</button>');
                }
            }
    ...
    const init_form_to_value_zero = function(){
        $('#maintenance_job_vehicle_id').val("");
        $('.lo_no').show();
    ...
    function remove(){
        $.post("{{route('maintenance.job.vehicle.delete')}}", {
            ...
            loadMaintenanceJobVehicle();
        })
    }

    const submitMaintenanceJobVehicle = function(data) {

        let form = $('#frmAddMaintenanceVehicle');
        $('.hasErr').html('');

        let maintenance_job_purpose_type = $.map($('.form_check_purpose_type:checked'), function(n, i){
            return n.value;
        }).join(',');

        data.append('maintenance_job_purpose_type', maintenance_job_purpose_type);

        $.ajax({
            url: "{{ route('maintenance.job.vehicle.save') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                // $('#submitMaintenanceJobVehicle').modal('hide');
    ...
    const selectMaintenanceJobVehicle = function(id){
        $('#selectMaintenanceJobVehicle').find('#detail_id').val(id);
    }

    const assignVehicleAppointment = function(data){
        $.ajax({
            url: "{{ route('maintenance.job.vehicle.assignAppointment') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                console.log(response);
                $('#selectMaintenanceJobVehicle').modal('hide');
                loadMaintenanceJobVehicle();
            },
            error: function(response) {
                let errors = response.responseJSON.errors;
    ...
    const init_func_vehicle_edit = function(){
        ...
        $('#frmEditMaintenanceVehicle').on('submit', function(e) {
            ...
            submitEditMaintenanceJobVehicle(formData);
    ...
    const addMaintenanceVehicle = function(){
        ...
        $('#maintenance_job_vehicle_id').val(null);

        init_form_to_value_zero();
        let submitMaintenanceJobVehicle = $('#submitMaintenanceJobVehicle');
        let add_vehicle = $('.add_vehicle');
        // let add_next_vehicle = $('.add_next_vehicle');
        let edit_vehicle = $('.edit_vehicle');
        submitMaintenanceJobVehicle.find('#brand').val(null).trigger('change');
        submitMaintenanceJobVehicle.find('#fuel_type_id').val(null).trigger('change');
        ...
        submitMaintenanceJobVehicle.modal('show');
    }

    const displayMaintenanceJobVehicle = function(self){
        ...
        let targetModal = $('#displayMaintenanceJobVehicleModal');

        $('#purpose_type').html('');

        purpose_type.forEach(element => {
            targetModal.find('#purpose_type').append('<li>'+element.desc+'</li>');
        });
    ...
    const editMaintenanceVehicle = function(vehicle_id, is_display){

        $('#maintenance_job_vehicle_id').val(vehicle_id);

        parent.startLoading();

        let editMaintenanceVehicleModal = $('#submitMaintenanceJobVehicle');
        $('#display_list_sub_category').show();
        $('#display_list_sub_category_type').show();
        $.ajax({
            url: '{{Route("maintenance.job.vehicle.getVehicleForm")}}',
            type: 'get',
            data: {
            ...
            dataType: 'json',
                success: function(data) {
                    ...
                    $('.form_check_purpose_type').prop('checked', false);

                    data.maintenance_job_purpose_type.forEach(element => {
                        $('#form_check_id_'+element).prop('checked', true);
                    });

                    $('.add_vehicle').hide();
                    $('.add_next_vehicle').hide();
                    $('.edit_vehicle').show();
                    $('#maintenance_job_vehicle_id').val(data.id);
                    ...
                    $('#complaint_damage').val(data.complaint_damage);
                    if(data.last_service_dt){
                        $('#last_service_dtInput').val(moment(data.last_service_dt, 'YYYY-MM-DD').format('DD/MM/YYYY'));
                    }
    ...
    function checkExistRegNumber(plate_no){
        ...
        $('.hasErr').html('');
        let vehicle_id = $('#maintenance_job_vehicle_id').val();
        $.ajax({
            url: "{{ route('maintenance.job.vehicle.checkExistRegNumber') }}",
            type: 'post',
            data: {
    ...
    $(document).ready(function(){
        ...
        let last_service_dtInput = $('#last_service_dtInput').datepicker();
        ...
        $('#frmAddMaintenanceVehicle').on('submit', function(e) {
            ...
            submitMaintenanceJobVehicle(formData);
        ...
        $('#frmselectMaintenanceJobVehicle').on('submit', function(e){
            e.preventDefault();
            let formData = new FormData(this);
