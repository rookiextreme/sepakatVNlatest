...
<body class="content">
<div class="mytitle">Kategori Kenderaan</div>
            ...
            <tbody id="sortable">
                @foreach ($categories as $category)
                    <tr id="category_id_{{$category->id}}">
                        ...
                        <td class="cfoc key"><a href="#" onclick="modalActionCategory(this, 'update')" data-id="{{$category->id}}" data-code="{{$category->code}}" data-name="{{$category->name}}" data-bs-toggle="modal" data-bs-target="#categoryModal" data-toggle="popover" data-trigger="focus" data-placement="top">{{$category->name}}</a></td>
                        <td style="width: 30px" class="text-end" onclick="displaySubCategory(this, {{$category->id}}, '{{$category->code}}', '{{$category->name}}')"><i id="angle" class="fa fa-angle-up fa-2x"></i></td>
                    </tr>
...
<script>
    ...
    function getSubCategory(category_id){
        ...
        $.ajax({
            url: "{{route('reference.getSubCategory')}}",
            data: {
    ...
    function getSubCategoryType(sub_category_id){
        $('#sub_category_type').hide();
        $.ajax({
            url: "{{route('reference.getSubCategoryType')}}",
            data: {
