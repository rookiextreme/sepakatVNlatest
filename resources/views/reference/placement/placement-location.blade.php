        ...
        <div class="col-md-12">
            <div class="float-end">
                <div class="input-group">
                    <input type="search" onkeyup="searching(this.value)" type="text" class="form-control search" placeholder="Carian Lokasi Penempatan" value="{{$search}}">
...
<script>
    ...
    function searching(value){
        ...
        if(keycode ==  13 || !value){
            parent.openPgInFrame("{{route('reference.placement-location')}}?search="+value);
        }
    }
