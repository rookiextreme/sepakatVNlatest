        ...
        <div class="col-md-12">
            <div class="float-end">
                <div class="input-group">
                    <input type="search" onkeyup="searching(this.value)" type="text" class="form-control search" placeholder="Carian Komponen Kenderaan" value="{{$search}}">
...
<script>
    ...
    function searching(value){
        ...
        if(keycode ==  13 || !value){
            parent.openPgInFrame("{{route('reference.vehicle-component')}}?search="+value);
        }
    }
