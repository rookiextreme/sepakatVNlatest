...
<body class="content">
<div class="mytitle printme">Ringkasan Kenderaan Mengikut JKR Woksyop</div>
<div class="sect-top no-printme">
    <div class="mytitle">Ringkasan Kenderaan Mengikut JKR Woksyop Sehingga {{\Carbon\Carbon::now()->format('d F Y')}}</div>
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Ringkasan Kenderaan Mengikut JKR Woksyop</li>
        </ol>
    </nav>
</div>
...
<div class="btn-group float-end mt-2">
    ...
    <a class="btn cux-btn bigger no-printme" href="{{route('report.report.vehicle.export.excel', ['view' => 'report_vehicle_jkr_workshop_ownership'])}}"> <i class="fa fa-file-export"></i> Excel</a>
</div>
<div class="main-content col-xxl-8 col-xl-8 col-lg-10 col-md-10 col-sm-12" style='margin-top:50px;'>
