            ...
            <table style='border:2px solid grey;'>
                ...
                <tbody>
                    ...
                    <tr style='border-top:2px solid grey'>
                        {{-- <td class="end thin-underline"></td> --}}
                        <td class="row-item thin-underline" style='text-align:right;border-right:2px solid grey;padding-right:5px'>Pembaikan Besar Siap mengikut Piagam Pelanggan</td>
                    ...
                    <tr style='border-bottom:2px solid grey'>
                        {{-- <td class="end thin-underline"></td> --}}
                        <td class="row-item thin-underline" style='text-align:right;border-right:2px solid grey;padding-right:5px;font-family:mark-bold'>Peratus Siap mengikut Piagam Pelanggan</td>
                    ...
                    <tr style='border-top:2px solid grey'>
                        {{-- <td class="end thin-underline"></td> --}}
                        <td class="row-item thin-underline" style='text-align:right;border-right:2px solid grey;padding-right:5px'>Pembaikan Kecil Siap mengikut Piagam Pelanggan</td>
