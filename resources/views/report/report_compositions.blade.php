        ...
        <div class="col-xl-2 col-lg-2 col-md-3">
            <div class="form-group">
                ...
                <select class="form-select" name="" id="vehicle_report_composition">
                    ...
                    <option title="Laporan Mengikut Pengeluar" value="brand" {{$composition_by == 'brand' ? 'selected' : ''}}>Pengeluar</option>
                    ...
                    <option title="Laporan Mengikut Hak Milik" value="ownership" {{$composition_by == 'ownership' ? 'selected' : ''}}>Hak Milik</option>
...
<section id="details" class="tab-content">
    <div class="paper">
        ...
        <hr/>
        <div style="font-family: mark;font-size:12px;margin-bottom:4px">{{count($data)}} rekod</div>
    </div>
</section>
{{-- @json($data) --}}
@endif
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        $('#vehicle_report_composition').select2({
            ...
            openPgInFrame("{{route('report.report_compositions')}}?composition_by="+type+"&composition_title="+composition_title+"&graph_type="+graph_type);
        });
