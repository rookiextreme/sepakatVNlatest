...
<body class="content">
<div class="mytitle printme">Pecahan Kenderaan Mengikut Jenis ({{$owner_type_desc}})</div>
<div class="sect-top no-printme">
    <div class="mytitle">Pecahan Kenderaan Mengikut Jenis ({{$owner_type_desc}}) Sehingga {{\Carbon\Carbon::now()->format('d F Y')}}</div>
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Pecahan Kenderaan Mengikut Jenis ({{$owner_type_desc}})</li>
        </ol>
    </nav>
</div>
...
<div class="btn-group float-end mt-2">
    ...
    <a class="btn cux-btn bigger no-printme" href="{{route('report.report.vehicle.export.excel', ['view' => 'report_vehicle_jkr_cat_type', 'owner_type_code' => Request('owner_type_code')])}}"> <i class="fa fa-file-export"></i> Excel</a>
</div>
        ...
        <table style='width:100%'>
            <thead>
                <tr>
                    ...
                    <td class="col-mth header-depreciation text-center" style='color:black !important; font-family:mark-bold;' colspan="{{count($state_list)}}" >Negeri</td>
                ...
                <tr>
                    @foreach ($state_list as $state)
                        <td class="col-mth header-depreciation text-center" style='color:black !important; font-family:mark-bold;'>{{$state->desc}}</td>
                    @endforeach
                </tr>
            </thead>
            <tbody>
