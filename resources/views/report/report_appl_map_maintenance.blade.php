...
<body>
<div class="sect-top">
    <div class="spectitle">Taburan Penyenggaraan</div>
...
<div class="whole-map">
    ...
    <div class="map-left">
        ...
        @foreach ($woksyop_list as $state)
            ...
            <div id="info-{{$woksyopRefs[$state->code]['spot']}}" class="info" onClick="alert('Jumlah Penilaian {{$totalP_Peninsular}} untuk {{$state->desc}}');"><div class="count">{{$totalP_Peninsular}}</div>{{$new_name}}</div>
            @endif
        @endforeach
	...
	<div class="map-right">
        ...
        @foreach ($woksyop_list as $state)
            ...
            @endphp
            @if(isset($woksyopRefs[$state->code]) && $woksyopRefs[$state->code]['view'])
            <div id="info-{{$woksyopRefs[$state->code]['spot']}}" class="info" onClick="alert('Jumlah Penilaian {{$totalP_East}} untuk {{$state->desc}}');"><div class="count">{{$totalP_East}}</div>{{$new_name}}</div>
            @endif
        @endforeach
