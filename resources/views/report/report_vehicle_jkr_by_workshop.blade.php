...
<div class="btn-group float-end mt-2">
    ...
    <a class="btn cux-btn bigger no-printme" href="{{route('report.report.vehicle.export.excel', ['view' => 'report_vehicle_jkr_workshop'])}}"> <i class="fa fa-file-export"></i> Excel</a>
</div>
<div class="main-content col-xxl-6 col-xl-6 col-lg-8 col-md-10 col-sm-12" style='margin-top:50px;'>
