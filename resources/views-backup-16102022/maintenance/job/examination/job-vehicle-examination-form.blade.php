@php
    ...
    if($detail->hasJVEForm){
        ...
        if($repair_method_id){
            ...
            else if($hasRepairMethod->code == '02'){
        ...
        if($detail->hasInternalRepairStatus && in_array($detail->hasInternalRepairStatus->code, ['01','02','03','07'])){
            $showInternalForm = true;
        } else if( (!$detail->hasInternalRepairStatus || $detail->hasInternalRepairStatus->code == '04') && $detail->hasExternalRepairStatus && in_array($detail->hasExternalRepairStatus->code, ['04','05','08'])){
            $showExternalForm = true;
        }
    }
@endphp
...
<body class="content">
    ...
    <div class="main-content">
            ...
            <div class="wrapper" style="position: relative">
                <ul id="tabActive">
                    ...
                    @if($showInternalForm || $showExternalForm)
                        <li class="cub-tab" style="display: {{in_array($MJobVehicleStatus->code, ['07','11','12']) && $showInternalForm ? '' : 'none'}};" onClick="goTab(this, 'maintenance');" id="tab4">Senggara (Secara Dalaman)</li>
                        <li class="cub-tab" style="display: {{in_array($MJobVehicleStatus->code, ['11','12']) && $showExternalForm ? '' : 'none'}};" onClick="goTab(this, 'monitoring');" id="tab5">Pemantauan (Secara Luaran)</li>
                    @else
                        <li class="cub-tab" style="display: {{in_array($MJobVehicleStatus->code, ['07','11','12']) ? '' : 'none'}};" onClick="goTab(this, 'maintenance');" id="tab4">Pengujian</li>
                    @endif
                </ul>
        ...
        <section style="display: {{in_array($MJobVehicleStatus->code, ['07','11','12']) && $showInternalForm ? '' : 'none'}};" id="maintenance" class="tab-content">
            @include('maintenance.job.examination.tab.maintenance')
        </section>
        <section style="display: {{in_array($MJobVehicleStatus->code, ['11','12']) && $showExternalForm ? '' : 'none'}};" id="monitoring" class="tab-content">
