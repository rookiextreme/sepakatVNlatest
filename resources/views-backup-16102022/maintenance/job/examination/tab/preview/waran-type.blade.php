@php
    ...
    $waran_type_code = Request('waran_type_code') ? Request('waran_type_code') : null;
...
<body class="content">
    ...
    <script>
        ...
        const getWarrantByYear = function(self){
            ...
            window.location.href = url+"?waran_type_code={{$waran_type_code}}&selectedYear="+year;
        ...
        $(document).ready(function(){
            ...
            $('.dropdown-item.month').click(function(e){
                ...
                location.replace('{{ route('maintenance.job.vehicle.getVehicleForm.research.market.WaranType') }}'+'?waran_type_code={{$waran_type_code}}&selectedYear={{$selectedYear}}&selectedMonth='+clickedItem);
            });
