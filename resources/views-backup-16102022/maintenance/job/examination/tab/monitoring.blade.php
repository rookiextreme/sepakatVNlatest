...
<form id="frm_vehicle_monitoring">
    ...
    <div class="fixed-submit">
        ...
        @if(auth()->user()->isForemenMaintenance())
            @if(in_array($MJobVehicleStatus->code, ['11']) && $detail->hasExternalRepairStatus && $detail->hasExternalRepairStatus->code == '04')
                <button class="btn btn-module" type="button" data-bs-toggle="modal" data-bs-target="#prompMonitoringVerificationModal">Hantar Untuk Semakan</button>
    ...
    <div class="row">
        <p>
            PENGUJIAN SELEPAS PEMBAIKAN (CKM.J.01)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="ref_info_id" id="ref_info_id">
