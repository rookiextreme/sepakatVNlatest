<div class="small-title" style='margin-bottom:15px'>OSOL 28000 - PENYATA KEMAJUAN PERBELANJAAN BULAN {{strtoupper($monthDesc[$selectedMonth])}} {{$selectedYear}}</div>


<div class="row" id="osol280-parent">
    <div class="col-6 col-md-3 pe-0" id="container-osol-280-state">
        <table class="" style="width: 100%">
            <tbody>

                <tr>
                    <td class="col-mth header-depreciation left label_state" rowspan="1" colspan="2" style="height: 54px;">NEGERI
                    <div class="btn-group float-end d-none d-md-inline-flex btn-scoller">
                        <button type="button" class="btn cux-btn small" onclick="scrollToLeft('container-osol-280')"><i class="fa fa-arrow-left"></i></button>
                        <button type="button" class="btn cux-btn small" onclick="scrollToRight('container-osol-280')"><i class="fa fa-arrow-right"></i></button>
                    </div>
                    </td>
                </tr>
    ...
    <div class="col-6 col-md-9 ps-0 overflow-auto" id="container-osol-280">
        <table class="" style="width: 100%">
            <tr>
                ...
                <td class="col-mth header-depreciation" colspan='4'>PERBELANJAAN (RM)</td>
            ...
            <tbody>
                ...
                <tr data-id = "{{$osolItem->id}}" data-div-type = "osol28">
                    ...
                    @if($is_preview == 1)
                    @else
                    <td class="table-item cursor-pointer edit-add-item-adjustment" ><i class="fa fa-pencil-alt"></i></td>
                    @endif
