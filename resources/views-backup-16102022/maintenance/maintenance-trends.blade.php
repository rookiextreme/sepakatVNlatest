            ...
            <table class="table-custom">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="row-item thin-underline">Enjin </td>
                    ...
                    <tr>
                        <td class="end thin-underline"></td>
                        <td class="row-item thin-underline">Suspension & Handling </td>
                        <td class="col-focus link ">0</td>
                        <td class="col-focus link ">0</td>
                        <td class="col-focus link ">0</td>
                        <td class="col-focus link ">0</td>
                    ...
                    <tr>
                        <td class="end thin-underline"></td>
                        <td class="row-item thin-underline">Brek </td>
                        <td class="col-focus link ">0</td>
                        <td class="col-focus link ">0</td>
                        <td class="col-focus link ">0</td>
                        <td class="col-focus link ">0</td>
                    ...
                    <tr>
                        <td class="end thin-underline"></td>
                        <td class="row-item thin-underline">Jumlah</td>
                    ...
                    <tr>
                        <td class="end thin-underline"></td>
                        <td class="row-item thin-underline">Peratusan</td>
                        <td class="col-tren thin-underline"><div class="shape-incline"></div></td>
                        <td class="col-tren thin-underline"><div class="shape-incline"></div></td>
                        <td class="col-tren thin-underline"><div class="shape-decline"></div></td>
                        <td class="col-tren thin-underline"><div class="shape-incline"></div></td>
...
@if ($repair->monthly == 10)
    data[{{$repair->monthly}}] = {{$repair->count}};
@endif
...
@if ($service->monthly == 10)
    data[{{$service->monthly}}] = {{$service->count}};
@endif
