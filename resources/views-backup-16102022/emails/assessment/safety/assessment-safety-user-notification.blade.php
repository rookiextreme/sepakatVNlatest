...
$AssessmentSafetyVehicle = AssessmentSafetyVehicle::where('assessment_safety_id',$details['assessment_id'])
...
<div style="max-width:500px;font-size:12px;font-family:Arial, Helvetica, sans-serif">
    ...
    <br><br>
    Proses penilaian telah selesai bagi keputusan bagi kenderaan No. Pendaftaran <b>
        @foreach (  $AssessmentSafetyVehicle as $list)
                    {{$list->plate_no}} telah {{$list->approval == true ? "Lulus" : "Gagal"}},
        @endforeach
    </b>.
    Bagi pemohon bernama, {{$details['applicant_name']}}, sila log masuk untuk memuat turun Sijil Keselamatan & Prestasi.
    </div>
<br/>
<br/><br/><br/>
