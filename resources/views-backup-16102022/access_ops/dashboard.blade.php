...
// $expenses_mhpv = $general_record_count_view->total_expenses_mhpv ? $general_record_count_view->total_expenses_mhpv : 0;
// $allocation_mhpv = $general_record_count_view->total_allocation_mhpv ? $general_record_count_view->total_allocation_mhpv : 0;
// $percentage_expenses_mhpv = ($expenses_mhpv/$allocation_mhpv) * 100;
...
@php
    ...
    if(in_array($roleCode, array('01','02','03','04','07','13','14','15'))){
    ...
    if(in_array($roleCode, array('01','02','03','04','08','09','10','11','12'))){
        ...
        if(in_array($roleCode, array('04','12'))){
        ...
        $totalSenggaraanPemeriksaan =  $query = DB::select(DB::raw('
            ...
            '.$queryWorkshop.$queryAssistantEngginer.$myApp.'
            '))[0]->total;
    ...
    foreach ($stateListCount as $state) {
        switch ($state->code) {
            case '01':
            $totalJohor = $state->total_by_state;
            break;
            case '02':
            $totalKedah = $state->total_by_state;
            break;
            case '03':
            $totalKelantan = $state->total_by_state;
            break;
            case '04':
            $totalMelaka = $state->total_by_state;
            break;
            case '05':
            $totalNegeriSembilan = $state->total_by_state;
            break;
            case '06':
            $totalPahang = $state->total_by_state;
            break;
            case '07':
            $totalPerak = $state->total_by_state;
            break;
            case '08':
            $totalPerlis = $state->total_by_state;
            break;
            case '09':
            $totalPulauPinang = $state->total_by_state;
            break;
            case '10':
            $totalSabah = $state->total_by_state;
            break;
            // case '11':
            // $totalSelangor = $state->total_by_state;
            // break;
            case '12':
            $totalSelangor = $state->total_by_state;
            break;
            case '13':
            $totalTerengganu = $state->total_by_state;
            break;
            case '14':
            $totalKualaLumpur = $state->total_by_state;
            break;
            case '15':
            $totalLabuan = $state->total_by_state;
            break;
            case '16':
            $totalPutrajaya = $state->total_by_state;
            break;
        }
    }
    ...
    <div class="container-fluid">
        <div class="row">
            @if(!auth()->user()->detail->hasWorkshop)
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="notify_workshop">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="spectitle">Dashboard <span>Operasi</span></div>
            </div>
...
//        $totalSenggaraan = 2;$totalPenilaian = 1;
    @endphp
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="notify">
                <div class="alert alert-dismissible fade show" role="alert" style='background-color: #569fb7;color:#ffffff'>
                    @if ($totalPenilaian > 0 && $totalSenggaraan > 0)
                        Anda mempunyai {{$totalPenilaian}} permohonan penilaian dan {{$totalSenggaraan}} penyenggaraan untuk diambil tindakan.
                    @else
                        {{$totalPenilaian > 0 ? "Anda mempunyai ".$totalPenilaian." permohonan penilaian untuk tindakan.":""}}
                        {{$totalSenggaraan > 0 ? "Anda mempunyai ".$totalSenggaraan." permohonan penyenggaraan untuk tindakan.":""}}
                    @endif
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="$(this).alert('close')"><i class="fal fa-times" aria-hidden="true"></i></button>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12" style="position: relative;">
                ...
                <div class="info-box ps-1 pe-2">
                    ...
                    <figure class="highcharts-figure p-0" style="height:200px;">
                        <div id="chart-saman" style="height:180px;"></div>
                    </figure>
                ...
                <div class="row">
                        ...
                        <div class="info-box dark-cloud" id="box-logistics" style="background-image: url({{asset('my-assets/img/dark-cloud.png')}});position:relative">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-3 count mt-1">{{$general_record_count_view->total_logistic_booking ? $general_record_count_view->total_logistic_booking : 0 }}</div>
                                        <div class="col-9" style="position: relative;">
                        ...
                        <div class="info-box" id="box-maintenanance-warrants" style="padding-bottom:10px">
                            ...
                            <div class="row shade-floor p-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 cursor-pointer" onclick="parent.openPgInFrame('{{ route('maintenance.warrant.table', ['tab' => 1, 'mphv' => '28000'])}}')">
                                        <div class="section mt-3">
                                            MHPV 28000
                                        </div>
                                        <div style="position: relative;">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-7 col-12">
                        ...
                        <div class="info-box pb-0 box-tren-woksyop" style="position: relative;background-image: url({{asset('my-assets/img/tools.png')}});">
                            ...
                            <div class="row" id="bar-penyenggaraan" style="padding-bottom:0px;">
                                <div class="col-xl-3 col-lg-3 col-md-2 col-sm-2" style="padding-right:0px;height:111px">
                                    <div class="own-legend">
                                        <div class="row">
