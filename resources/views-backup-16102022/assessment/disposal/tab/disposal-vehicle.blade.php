      ...
      <div class="modal-content">
        ...
        <form id="frmAssignAssessmentVehicleAppointment" action="">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" onclick="loadAssessmentAccidentVehicle()" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            </div>
        </form>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    loadAssessmentAccidentVehicle = function() {
        let data = {
            'page': currentPage,
        }
            ...
            success: function(isExist) {
                ...
                if(isExist == 1){
                    ...
                    if($('[name="'+key+'"]').parent().find('.hasErr .text-danger').length == 0){
                        ...
                        $('[xmanufacture_year]').val(moment(moment(isExist.manufacture_year, 'YYYY')).format('YYYY'));
                        $('#registrationVehicleDtInput').val(moment(moment(isExist.registration_vehicle_dt, 'YYYY-MM-DD')).format('DD/MM/YYYY'));
                        ...
                        $('#aset_regno').val(isExist.aset_regno);
                        $('#nc_no').val(isExist.nc_no);
                        var original_price = isExist.original_price;
                        $('#original_price').val(currencyLocal(original_price));
                        var earlier_maintenance_cost = isExist.earlier_maintenance_cost;
