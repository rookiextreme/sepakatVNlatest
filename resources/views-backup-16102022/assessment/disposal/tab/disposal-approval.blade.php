...
<form class="row" id="frm_approval" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-12" id="assessment_disposal_vehicle_approval">
            ...
            <div class="row">
                <div class="col-md-12 mt-2 mb-2">
                    <div class="form-group center">
                        {{-- <span class="btn btn-module" onclick="prompassessmentDisposalApproveModal()">Hantar</span> --}}
...
<div class="modal fade" id="assessmentDisposalApproveModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="assessmentDisposalApproveModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    prompassessmentDisposalApproveModal = function(){
        $('#assessmentDisposalApproveModal').modal('show');
    }

    loadAssessmentDisposalVehicleApproval = function() {
        $.get("{{ route('assessment.disposal.vehicle-approval.list') }}", function(result){
            $('#assessment_disposal_vehicle_approval').html(result);
        });
    }
    ...
    assessmentVehicleApprove = function(self){
        ...
        $.post('{{route('assessment.disposal.approve')}}', {
            '_token': '{{ csrf_token() }}'
        }, function(response){
    ...
    formApprovalEngineer =  function(data){
        $.ajax({
            url: "{{ route('assessment.disposal.approval') }}",
            type: 'post',
            data: data,
            cache: false,
            contentType: false,
    ...
    $(document).ready(function(){
        loadAssessmentDisposalVehicleApproval();
