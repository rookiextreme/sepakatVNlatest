                    ...
                    @endphp
                     <tr>
                        ...
                        <td class="col-edit">
                            ...
                            <br>
                            <div class="btn-group">
                                    <button class='btn cux-btn' onclick="parent.openPgInFrame('{{route('assessment.currvalue.register', [ 'id' =>  $currvalue->id, 'tab' => $tab ])}}')"><i class="fa fa-pencil-alt"></i></button>
                        ...
                        <td><a href="{{route('assessment.currvalue.register', [ 'id' =>  $currvalue->id, 'tab' => $tab ])}}">{{$currvalue->ref_number}}</a></td>
                        <td><a href="{{route('assessment.currvalue.register', [ 'id' =>  $currvalue->id, 'tab' => $tab ])}}">{{$currvalue->applicant_name}}</a></td>
