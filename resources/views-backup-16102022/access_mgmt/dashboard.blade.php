                        ...
                        <div class="info-box dark-cloud" id="box-logistics" style="background-image: url({{asset('my-assets/img/dark-cloud.png')}});position:relative">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div onclick="openPgInFrame('{{ route('logistic.booking.list') }}')" class="col-3 count mt-1 cursor-pointer">{{$general_record_count_view->total_logistic_booking ? $general_record_count_view->total_logistic_booking : 0 }}</div>
                                        <div class="col-9" style="position: relative;">
