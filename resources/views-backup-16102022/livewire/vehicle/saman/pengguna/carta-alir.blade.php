    ...
    <style>
        ...
        <div  class="row">
            ...
            <div class="vl0 me-2 mt-5 ms-2">
                ...
                <div class="col-12">
                    <a class="text-decoration-none" href="{{route('saman.pengguna.rekod.status', ['id' => 2])}}">
                        <div class="card" style="width: 200px;top:-145px;border:none;left: -12px;">
                            ...
                            <div class="card-body border">
                                <h6 class="card-title text-success fw-bold">Saman Tertunggak</h6>
                                <div class="mt-4">
                                    <div class="display-5 text-dark fw-bold">
                                        {{$overdue}}
                                    </div>
                                    <p class="fw-bold text-dark">Saman</p>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="vl1 me-2 mt-5">
                <div class="kon diamond"></div>
                <div class="col-12">
                    <a class="text-decoration-none" href="{{route('saman.pengguna.rekod.status', ['id' => 4])}}">
                        <div class="card" style="width: 200px;top:-145px;border:none;left: 30px;">
                            ...
                            <div class="card-body border">
                                <h6 class="card-title text-primary fw-bold">Menunggu Semakan</h6>
                                <div class="mt-4">
                                    <div class="display-5 text-dark fw-bold">
                                        {{$verification}}
                                    </div>
            ...
            <div class="vl2 me-2 mt-5" style="height: 600px;">
                <div class="col-12">
                    <a class="text-decoration-none" href="{{route('saman.pengguna.rekod.status', ['id' => 3])}}">
                        <div class="card" style="width: 200px;top:-145px;border:none;left: 80px;">
                            <img src="{{asset("img/carta-alir/user/revoked.png")}}" alt="" class="card-img-top">
                            <div class="card-body border">
                                <h6 class="card-title text-primary fw-bold">Rekod Bayar Saman</h6>
                                <div class="mt-4">
                                    <div class="display-5 text-dark fw-bold">
                                        {{$paids}}
                                    </div>
