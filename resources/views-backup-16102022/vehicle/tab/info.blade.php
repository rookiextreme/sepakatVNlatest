            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        @else
                            <div class="input-group">
                                <select id="category_id" class="form-select form-control" name="category_id" onchange="getSubCategory(this.value)">
                                    <option value=""></option>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="input-group">
                            {{-- todo wired issue --}}
                            <select class="form-select  form-control" name="sub_category_id" id="list_sub_category" onchange="getSubCategoryType(this.value)">
                                <option value=""></option>
                            </select>
                        </div>
                        @endif
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        @else
                        <div class="input-group">
                            <select class="form-select form-control" name="sub_category_type_id" id="list_sub_category_type">
                                <option value=""></option>
                            </select>
                        </div>
                        @endif
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12">
                        ...
                        @if (!empty($is_display) && ($is_display == 1))
                            <div class="text-capitalize theme-color-text">
                                {{isset($detail['no_engine'])? $detail['no_engine'] : ''}}
                            </div>
                        @else
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12">
                        ...
                        @if (!empty($is_display) && ($is_display == 1))
                            <div class="text-capitalize theme-color-text">
                                {{isset($detail['no_chasis']) ? $detail['no_chasis'] : ''}}
                            </div>
                        @else
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12">
                        ...
                        @else
                        <input type="text" xprevalue="{{$detail['no_id_pemunya']}}" class="form-control" autocomplete="off" id="no_id_pemunya" name="no_id_pemunya" value="{{isset($detail['no_id_pemunya']) ? $detail['no_id_pemunya'] : ''}}">
                        @endif
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12">
                        ...
                        @else
                        <div class="input-group">
                            <select class="form-select  form-control" id="maklumat_pembuat" name="pembuat" onchange="getVehicleModel(this.value)">
                            <option value=""></option>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12" id="to_model"
                    style="{{$detail && $detail->brand && $detail->hasBrand()->id == 20 {{--$detail->hasVehicleModel()--}} ? 'display:none' : 'display:block'}}">
                        ...
                        <select class="form-select  form-control" name="model" id="list_vehicle_model">
                            <option value=""></option>
                        </select>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12" id="new_brand" style="{{$detail && $detail->brand ? 'display:block' : 'display:none'}}">
                        <label for="" class="form-label text-dark">Pembuat</label>
                        @if (!empty($is_display) && ($is_display == 1))
                            <div class="text-capitalize theme-color-text">
                        ...
                        @else
                        <div class="input-group">
                            <input type="text" class="form-control" name="new_brand" id="new_brand" value="{{$detail && $detail->brand ? ucfirst(trans($detail->brand)) : ''}}">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12" id="new_model" style="{{$detail && $detail->model ? 'display:block' : 'display:none'}}">
                        <label for="" class="form-label  text-dark">Model</label>

                        @if (!empty($is_display) && ($is_display == 1))
                            <div class="text-capitalize theme-color-text">
                                {{$detail && $detail->model ? $detail->model:''}}
                            </div>
                        @else
                        <div class="input-group">
                            <input type="text" class="form-control" name="new_model" id="new_model" value="{{$detail && $detail->model ? ucfirst(trans($detail->model)) : ''}}">
                        </div>
                        @endif
                    </div>
                    ...
                    @if($currentFleetTable == 'department')
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                overflow: auto;">
                                    <embed src="{{$pathUrl}}" id="preview-file-embed" width="50%" type="">
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                <form id="frmVehicleImage" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="vehicleImage" class="form-label">Muat Naik<br/><span class="btn cux-btn bigger mt-2" style="text-transform: none"><i class="fa fa-upload"></i> Pilih Gambar</span></label>
                    ...
                    <div class="modal-footer justify-content-start">
                        <button class="btn btn-module" type="submit" xaction="upload_image">Muat Naik</button>
...
<script type="text/javascript">
    ...
    function checkExistColumn(column, value){
        ...
        elemt.parent().find('.hasErr').remove();
        ...
        $.ajax({
            ...
            success: function(isExist) {
                ...
                let errorsHtml = '';
                if(isExist == 1){
                    elemt.parent().append('<div class="hasErr text-danger col-12 fs-6">'+columnDesc[column]+' '+value+' Telah Wujud</div>');
                    hasErrByColumn = true;
                    $('[type="submit"]').prop('disabled', true);
                } else {
                    hasErrByColumn = false;
    ...
    $(document).ready(function(){
        ...
        $('#maklumat_pembuat').on('change', function() {

            var maklumat_pembuat = $("#maklumat_pembuat").val();

            if (maklumat_pembuat == 20){

                $('#new_brand').attr('style','display:show');
                $('#new_model').attr('style', 'display:show');
                $('#to_model').attr('style', 'display:none');
            }else{

                $('#new_brand').attr('style','display:none');
                $('#new_model').attr('style', 'display:none');
                $('#to_model').attr('style', 'display:show');
