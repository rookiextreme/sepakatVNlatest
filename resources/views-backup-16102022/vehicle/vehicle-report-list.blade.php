...
<body class="content">
    ...
    <div class="dropdown inline" style="display: inline;">
        ...
        <ul class="dropdown-menu no-print" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="dropdown-item" onclick="parent.openPgInFrame('{{ route('report.vehicle-list', ['ownership' => 'jkr', 'fleet_view' => 'department', 'limit' => Request('limit')])}}')">Milik JKR</a></li>
            <li><a class="dropdown-item" onclick="parent.openPgInFrame('{{ route('report.vehicle-list', ['ownership' => 'public', 'fleet_view' => 'public', 'limit' => Request('limit')])}}')">Awam / Projek</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" onclick="parent.openPgInFrame('{{ route('report.vehicle-list', ['ownership' => 'disposal', 'fleet_view' => 'disposal', 'limit' => Request('limit')])}}')">Rekod Arkib</a></li>
        </ul>
    </div>
...
<div class="main-content" style="padding:0px;">
    @if($xmode == 'list')
        ...
        <div class="table-responsive" style="width:100%;padding-left:25px;padding-right:25px;margin-top:10px;padding-bottom:5px">
            ...
            <br/>
            <div class="pagin">{{$department->links('pagination.default')}}</div>
            <p>&nbsp;</p>
        </div>
    @endif
</div>
