...
class PikatMigrationSeederKemalangan extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $listMigrate = DB::connection('pgsql_jvp_public')->select('select * from "public".permohonan where (kod_status = 4 or kod_status = 5) and kod_penilaian = 6   ');
        ...
        foreach ($listMigrate as $key) {
            ...
            $Penilaian->createAssessmentKemalangan($key);
