...
class CreateVehicleValidationView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Menunggu pengesahan / waiting approval status for vehicle
        $approval = KenderaanStatus::where('code', '03')->first();
        ...
        ->where(['vapp_status_id' => $approval->id])
        ...
        Schema::createView('fleet.validation_vehicle_view', $queryDepartment->union($queryPublic));
    }
    ...
    {
        Schema::dropViewIfExists('fleet.validation_vehicle_view');
    }
}
