...
class CreateFleetDepartmentView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
    DB::statement("
    CREATE VIEW fleet.fleet_department_view AS (
        ...
        \"rvs\".\"desc\" as \"STATUS\"
        from \"fleet\".\"fleet_department\" as \"fd\"
    ...
    {
        Schema::dropViewIfExists('fleet.fleet_department_view');
    }
}
