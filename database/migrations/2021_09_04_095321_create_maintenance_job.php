...
class CreateMaintenanceJob extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('maintenance.job', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('assistant_engineer_service_by')->nullable();
            $table->foreign('assistant_engineer_service_by')->references('id')->on('users.users');

            $table->unsignedBigInteger('assistant_engineer_repair_by')->nullable();
            $table->foreign('assistant_engineer_repair_by')->references('id')->on('users.users');
    ...
    {
        Schema::dropIfExists('maintenance.job');
    }
}
