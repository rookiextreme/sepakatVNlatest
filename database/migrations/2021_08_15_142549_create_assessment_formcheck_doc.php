...
class CreateAssessmentFormcheckDoc extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assessment.assessment_formcheck_doc', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('assessment.assessment_formcheck_doc');
    }
}
