...
class CreateMaintenanceFormChecklistLvl2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('maintenance.form_checklist_lvl2', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('formchecklistlvl1_id')->references('id')->on('maintenance.form_checklist_lvl1');
    ...
    {
        Schema::dropIfExists('maintenance.form_checklist_lvl2');
    }
}
