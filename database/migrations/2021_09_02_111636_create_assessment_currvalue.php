...
class CreateAssessmentCurrvalue extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('assessment.assessment_currvalue', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('assessment.assessment_currvalue');
    }
}
