...
class CreateFunctionAssessmentNvAudit extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        CREATE OR REPLACE FUNCTION "assessment"."assessment_nv_audit_func"()
      ...
      begin
               ...
               VALUES (\'Kenderaan Baharu\', OLD.plate_no, TG_OP, to_json(NEW)::jsonb);
               RETURN NEW;
             ELSIF TG_OP = \'UPDATE\'
              THEN
              IF NEW != OLD THEN
              ...
              VALUES (\'Kenderaan Baharu\', OLD.plate_no, TG_OP, to_json(
           json_build_object(
