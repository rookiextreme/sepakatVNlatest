...
class CreateMaintenanceJobVehicleExaminationForm extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('maintenance.job_vehicle_examination_form', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('vehicle_id')->nullable();
            $table->foreign('vehicle_id')->references('id')->on('maintenance.job_vehicle');

            $table->string('repair_method',10)->nullable();
            $table->string('other_external_note')->nullable();
            $table->tinyInteger('is_research_market')->nullable();
            $table->tinyInteger('is_research_market_external')->nullable();
            ...
            $table->unsignedBigInteger('internal_quot_id')->nullable();
            $table->foreign('internal_quot_id')->references('id')->on('maintenance.quotation');
            
            $table->unsignedBigInteger('external_quot_id')->nullable();
            $table->foreign('external_quot_id')->references('id')->on('maintenance.quotation');
    ...
    {
        Schema::dropIfExists('maintenance.job_vehicle_examination_form');
    }
}
