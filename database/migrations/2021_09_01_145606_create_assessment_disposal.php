...
class CreateAssessmentDisposal extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assessment.assessment_disposal', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('assessment.assessment_disposal');
    }
}
