...
class CreateAssessmentGovLoan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('assessment.assessment_gov_loan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('assessment.assessment_gov_loan');
    }
}
