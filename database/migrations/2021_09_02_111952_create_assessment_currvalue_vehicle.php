...
class CreateAssessmentCurrvalueVehicle extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('assessment.assessment_currvalue_vehicle', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('assessment_currvalue_id')->nullable();
            $table->foreign('assessment_currvalue_id')->references('id')->on('assessment.assessment_currvalue');
            ...
            $table->string('evaluation_currvalue_type')->nullable()->default('ADALAH DIPERAKUI BAHAWA KENDERAAN');
            ...
            //untuk kaedah penilaian harga semasa
            ...
            //untuk kaedah penilaian sisa besi
            $table->float('metal_price')->nullable();
            ...
            $table->string('certificate_title',100)->nullable();
    ...
    {
        Schema::dropIfExists('assessment.assessment_currvalue_vehicle');
    }
}
