...
class CreateFunctionAssessmentCvAudit extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        CREATE OR REPLACE FUNCTION "assessment"."assessment_cv_audit_func"()
      ...
      begin
               ...
               VALUES (\'Harga Semasa\',OLD.plate_no, TG_OP, to_json(NEW)::jsonb);
               RETURN NEW;
             ELSIF TG_OP = \'UPDATE\'
              THEN
              IF NEW != OLD THEN
              ...
              VALUES (\'Harga Semasa\',OLD.plate_no, TG_OP, to_json(
           json_build_object(
