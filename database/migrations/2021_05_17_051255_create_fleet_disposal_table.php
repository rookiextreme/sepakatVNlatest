...
class CreateFleetDisposalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fleet.fleet_disposal', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('disposal_id')->references('id')->on('ref_disposal');
